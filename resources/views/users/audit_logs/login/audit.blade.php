@include('users.audit_logs.login.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/login-logs" class="active text-secondary"> Log Login</a></li>
              </ul>
            </div>
          </div>
                  ...
                  <div class="userlist_tab_content">
                        <div class="userlist_tab_contents_holder">
                          <div id="jps_card" class="card-body p-3">
                            ...
                            <table id="loginlogtable" width="100%" class=" display p-3 userlist_tab_content_table table table-responsive">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th class="col-2">No. Kad Pengenalan</th>
                                        <th class="col-2">Nama Pegawai</th>
                                        <th class="col-2">Jawatan</th> 
                                        <th class="col-1"><i>Event</i></th>
                                        <th class="col-1">Alamat IP</th> 
                                        <th class="col-3">Maklumat Laman Sesawang</th>             
                                        <th class="col-2">Dibuat Pada</th>             
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
@endsection
@include('users.audit_logs.login.script')
