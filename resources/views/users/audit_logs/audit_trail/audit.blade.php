          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/project-logs" class="active text-secondary">Log Projek</a></li>
              </ul>
            </div>
          </div>
                  ...
                  <div class="userlist_tab_content">
                    <div class="userlist_tab_contents_holder">
                      <div id="jps_card" class="card-body p-3">
                          <div class="dic_date col-lg-6 col-md-6 col-xs-6 row" style="justify-content: right;">
                            <input type="text" name="datefilter" id="datefilter" class="form-control datefilter col-lg-6 col-md-6 col-8 mr-3 my-2" autocomplete="off" placeholder="dd/mm/yyyy - dd/mm/yyyy" value="" />
                            <select id="mySelect" class="form-control col-lg-4 col-md-4 col-8 my-2">
...
@endsection
@include('users.audit_logs.audit_trail.script')
