...
.vmpop_btn {
  ...
  .RP_modal_container #exampleModal {
    background-color: rgba(0, 0, 0, 0.2);
  }
  .RP_modal_container #exampleModalToggle {
    background-color: rgba(0, 0, 0, 0.2);
  }
  .RP_modal_container #exampleModalToggle2 {
    background-color: rgba(0, 0, 0, 0.2);
  }
  .RP_modal_container #exampleModalToggle3 {
    background-color: rgba(0, 0, 0, 0.2);
  }
  select {
    -webkit-appearance: none;
...
.RP_modal_container #exampleModal .modal-dialog .modal-content .modal-header button {
  background-color: transparent;
  border: none;
}
.rp_pop_btn {
