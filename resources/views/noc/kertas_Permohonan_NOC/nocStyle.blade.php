...
.susun_pemberat, .pemberat_greenBtn {
  color: #000;
...
.add_role_sucess_modal_container #popup_sucess_modal {
  background-color: rgba(0, 0, 0, 0.2);
}
...
.NOC_box_content_kementerian::before {
  width: 16px;
  content: " ";
  background-image: url("../images/Arrow_10.png");
  background-position: left;
...
.NOC_box_content_kementerian.end::before {
  transform: rotate(-180deg);
  left: -14%;
  top: 30%;
  height: 20px;
}
.NOC_box_content_kementerian.bend::before {
  transform: rotate(90deg);
  left: 47%;
  top: 120%;
  height: 20px;
}
.NOC_box_content_kementerian p {
  margin: 0;
  box-shadow: rgba(0, 0, 0, 0.1) 0px 10px 15px -3px,
    rgba(0, 0, 0, 0.05) 0px 4px 6px -2px;
  background-color: #eeeeee;
...
.NOC_box_content_kementerian p.yellow {
  background-color: #fcf0b3;
}
.NOC_box_content_EPU {
  width: 40%;
...
.NOC_box_content_EPU.end::after {
  transform: rotate(-180deg);
  left: -14%;
  top: 30%;
  height: 20px;
}
.NOC_box_content_EPU.bend::before {
  transform: rotate(90deg);
  left: 47%;
  top: 120%;
  height: 20px;
}
.NOC_box_content_EPU p {
  margin: 0;
  box-shadow: rgba(0, 0, 0, 0.1) 0px 10px 15px -3px,
    rgba(0, 0, 0, 0.05) 0px 4px 6px -2px;
  background-color: #eeeeee;
...
.NOC_box_content_EPU p.yellow {
  background-color: #fcf0b3;
}
.NOC_flow_Chart_container {
  width: 90%;
  margin: 5%;
  padding: 2% 2%;
  border-radius: 0.5rem;
...
.NOC_flow_Chart_content {
  width: 50%;
}
/* .NOC_flow_Chart_content_kementerian {
  width: 40%;
}
.NOC_flow_Chart_content_epu {
  width: 40%;
} */
.NOC_flow_Chart_content h5 {
  font-size: 0.75rem;
  background-color: #4bcfc7;
  padding: 2%;
  text-align: center;
...
.NOC_box_content_EPU_lulus::before {
  width: 16px;
  content: " ";
...
.NOC_perubahanMaklumat {
  border: 1px solid #eeeeee;
  background-color: #eeeeee;
}
.NOC_perubahanMaklumat .container1 {
  background-color: #eeeeee;
  color: #595d6e;
  font-family: Poppins_bold;
  font-size: 0.8rem;
}
.NOC_perubahanMaklumat .container2 {
  color: #595d6e;
  font-family: Poppins_Regular;
  font-size: 0.8rem;
}
...
option:disabled {
    color: #becad4!important;
}

button.susun_pemberat.mt-2 {
    float: right;
    margin-right: 6px;
    /* margin-bottom: 26px; */
    width: 10%;
...
.toggle-button.active .slider-data {
    left: 20px;
    background-color: #ffff; /* Darker green when active */
}
...
p#lampiran_pindan_file_name_error {
    padding-left: 8%;
}
p#maklubalas_file_name_error {
    padding-left: 20%;
}
