                  ...
                  <div class="project_register_search_container">
                    <div class="card-body">
                        ...
                        <div>
                         ...
                         <br>
                          ...
                          <br>
                            ...
                            <div class="row">
                              <div class="upload_img m-3" id="economi_list">
                              </div>
                            </div>

                        <label class="pemberat_title" for=""><b>Status Permohonan</b></label>
                        <div>
                            <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" checked="">
                            <label class="form-check-label NOC_label" for="inlineRadio1">Lulus</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
                            <label class="form-check-label NOC_label" for="inlineRadio2">Tidak Lulus</label>
                          </div>
                        </div><br>

                        <div class="row" id="catatan_div">
                        <label style="margin-left:19px !important;" class="NOC_label">Catatan Tambahan</label>
                        <textarea class="form-control" id="catatan" name="catatan" style="width:590px !important;height:100px !important;margin-left:19px !important; font-size:0.8rem"></textarea><br>

                        </div><br>

                          <div>
                            <label class="pemberat_title" for="">Tarikh Surat</label>
                        ...
                        <br>
                            ...
                            <div class="row">
                              <div class="upload_img m-3" id="surat_list">
                              </div>
                            </div>
                    </div>
                    <div class="userlist_content_header_right col-md-12 text-center">
...
@include('noc.kementerian.script')
@endsection
