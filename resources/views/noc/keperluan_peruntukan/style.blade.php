...
.Mainbody_conatiner
  ...
  background-image: url("../assets/images/select_down.png");
...
.Mainbody_content_nav_header.project_register.row.align-items-center.m-1 {
...
.keperluan_pink {
  background-color: #fcb5ffd4;
}

.SimpanBtnNOC {
  background-color: #5b63c3 !important;
