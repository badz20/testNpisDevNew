    ...
    <div class="project_register_content_container">
        <div class="project_register_search_container mt-3">
            ...
            <div class="userlist_tab_btn_container d-flex flex-sm-row flex-column align-items-center">
                <button class="active KON_blueNav jps_active" id="jps_active">JPS</button>
                <button class="KON_blueNav non_jps_active" id="non_jps_active">SUMBER KEWANGAN LAIN</button>
            </div>
            ...
            <div class="project_register_search_form_container">
                <form>
                    ...
                    <div class="row m-0 d-none" id="query_jenis_pembiayaan_div">
                        <div class="col-md-6 col-xs-12 mt-3">
                            <div class="row align-items-center">
                                <div class="col-md-3 col-xs-12">
                                    <label class="pemberat_title" for="Rolling Plan">Jenis Pembiayaan</label>
                                </div>
                                <div class="col-md-9 col-xs-12 form-group">
                                    <select class="form-control" id="query_jenis_pembiayaan">
                                        <option value="">--Pilih--</option>
                                    </select>
                                </div>
                            </div>
...
@include('perunding.senaraiJps.scripts')
@endsection