...
$(document).ready(function() {
    ...
    $(".resetbtn").click(function() {
        ...
        document.getElementById("query_jenis_pembiayaan").value = ''
    })

    $(".jps_active").click(function() {
      document.getElementById('query_jenis_pembiayaan_div').classList.add("d-none");
      document.getElementById('jps_active').classList.add("active");
      document.getElementById('non_jps_active').classList.remove("active");
      document.getElementById('senarai_heading').innerHTML= 'SENARAI PERUNDING PROJEK JPS'
      document.getElementById("query_nama_projek").value = ''
        document.getElementById("query_jenis").value = ''
        document.getElementById("query_kod_projek").value = ''
        document.getElementById("query_kaedah").value = ''
    ...
    $(".non_jps_active").click(function() {
      document.getElementById('query_jenis_pembiayaan_div').classList.remove("d-none");
      document.getElementById('non_jps_active').classList.add("active");
      document.getElementById('jps_active').classList.remove("active");
      document.getElementById('senarai_heading').innerHTML= 'SENARAI PERUNDING PROJEK JPS SUMBER KEWANGAN LAIN'
      document.getElementById("query_nama_projek").value = ''
        document.getElementById("query_jenis").value = ''
        document.getElementById("query_kod_projek").value = ''
        document.getElementById("query_kaedah").value = ''
    ...
    $(".caribtn").click(function() {
        ...
        data['query_jenis_pembiayaan'] = document.getElementById("query_jenis_pembiayaan").value
...
function loadQueryDatas(response)
{
  ...
  //load nama perunding options
  query_jenis_pembiayaan_dropdown = document.getElementById('query_jenis_pembiayaan')
  response.jenis_pembiayaan.forEach((pembiayaan) => {
    var el = document.createElement("option");
      el.textContent = pembiayaan;
      el.value = pembiayaan;
      query_jenis_pembiayaan_dropdown.appendChild(el);
  })
