...
table {
  ...
  .Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .table_holder .table_preview thead tr th {
    background-color: #ffffff;
    padding: 0.75rem;
    font-size: 0.85rem;
    color: #656b9b;
  ...
  .Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .table_holder .table_preview tbody tr td {
    border-top: 1px solid #dee2e6;
    padding: 0.48rem;
    font-size: 0.82rem;
    color: #818390;
