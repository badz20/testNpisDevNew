...
button.ml-2.addsubrow, button.p_addsubrow,button.subminusbutton {
    background-color: transparent;
    border: none;
    padding: 0;
}
...
.searchIn{
  ...
  input#sup_perkara_sub_text, input#perkara_sub_text
  {
     height:40px !important;
  }

  .lejjar_perunding_body{
