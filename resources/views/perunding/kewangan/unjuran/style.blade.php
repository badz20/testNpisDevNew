...
button.ml-2.addsubrow,
button.p_addsubrow,
button.subminusbutton {
    background-color: transparent;
    border: none;
    padding: 0;
}

select#sub_peraku_select {
    max-width: 100%;
}
...
i.ri-add-box-line.ri-xl.kewangan_icon_grey,
i.ri-checkbox-indeterminate-line.ri-xl.kewangan_icon_grey,
i.ri-add-box-line.ri-xl,
i.ri-checkbox-indeterminate-line.ri-xl {
    cursor: pointer;
}
