                ...
                <div class="col-10">
                    <div class="topnav" id="myTopnav">
                        ...
                        <a class="active col-md-2"
                            href="/kewangan/yuran-perunding/{{$project_id}}/{{$perolehan_id}}">Yuran Perunding</a>
                    ...
                    <div class="card mt-5" style="background-color: white;">
                        ...
                        <div class=" card-body">
                            ...
                            <h5 class="KON_h5_label">LAMPIRAN B - RINGKASAN TUNTUTAN BAYARAN YURAN PERUNDING</h5>
                            <div class="card project_register_search_container mt-3">
                                <div class="card-body">
                            ...
                            <div style="overflow-x: auto" class="mt-5">
                                <table class="table table-bordered"  id="yuran_table" style="width:150em !important;">
...
@include('perunding.kewangan.yuran_perunding.script')
@endsection