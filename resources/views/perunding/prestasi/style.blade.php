...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holder .table_preview.application_list tbody tr:nth-child(even) {
    background-color: #ffffff;
}

.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holder .table_preview.application_list thead tr th {
    background-color: #ffffff;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_btn_container ul li.active .tab_image {
    border: 0.2rem solid #39afd1 !important;
}
...
@media (min-width: 821px) {
    .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_btn_container ul li .tab_image {
        ...
        border: 0.2rem solid #d9e9f8 !important;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .creativity-index-page .create-input::-webkit-outer-spin-button,
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .creativity-index-page .create-input::-webkit-inner-spin-button {
    -webkit-appearance: none;
    margin: 0;
}
...
.perunding_deliverables_tab {
    max-width: 100%;
}

.perunding_deliverables_tab table {
    border: 1px solid #c8cacd;
    border-collapse: collapse;
}

.perunding_deliverables_tab table th {
    text-align: center;
}

.perunding_deliverables_tab table tr td {
    border: #000;
}
...
.komponen_tab_rem tbody tr:nth-child(4) td,
.komponen_tab_rem tbody tr:nth-child(5) td,
.komponen_tab_rem tbody tr:nth-child(6) td {
    padding-left: 30px;
}
...
.kemaskini_perihal .footer_label {
    font-weight: bold;
}

.status_pelaksanaan_yellow {
    height: 50px;
    width: 65px;
    background-color: #d7c94e;
    padding: 2%;
    border: hidden;
    text-align: center;
    border-radius: 10px;
...
.status_pelaksanaan_purple {
    height: 50px;
    width: 65px;
    background-color: #BA99D3;
    padding: 5%;
    border: hidden;
    text-align: center;
    border-radius: 15px;
...
.userlist_tab_btn_container button.active {
    position: relative;
    color: #39b0d2;
}

.userlist_tab_btn_container button.active::before {
    position: absolute;
    content: "";
    width: 100%;
    bottom: -2px;
...
.userlist_content_header_right button {
    border: none;
    border-radius: 5px;
    padding: 0.4rem 0.8rem;
    color: #fff;
...
.userlist_content_header_right button.printing {
    background-color: #38afd1;
}

.project_register_search_container1 {
    background-color: white;
    box-shadow: 2px 5px 10px #888888;
}

.vmadd_role_sucess_modal_container #exampleModal {
    background-color: rgba(0, 0, 0, 0.2);
}
...
.KON_span :nth-child(1) {
    background-color: #fff;
    color: #000;
    border: none;
}

.KON_span :nth-child(2) {
    background-color: #fff;
    color: #000;
    border: none;
}
...
.KON_tblSejarah .KON_tblSejarah_head {
    background-color: #39afd1;
    color: #fff;
}

.KON_tblSejarah .KON_tblSejarah_body tr:nth-child(odd) {
    background-color: #f6f7fb;
}
...
@media (max-width: 576px) {
    ...
    .lokasi_img_container {
        align-items: center;
    }

    .lokasi_img_container p {
        font-family: Poppins_Regular;
        color: #666666;
        font-weight: 400;
        font-size: 3vmin;
    ...
    .Mainbody_conatiner .Mainbody_content .card .card-body h4 {
        text-align: center;
    }

    .Mainbody_conatiner .Mainbody_content .card .card-body .project_register_tab_container .project_register_tab_btn_container ul li h4 {
        font-size: 3vmin;
    }

    .Mainbody_conatiner .Mainbody_content .card .card-body .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content label {
        font-size: 4vmin;
    }

    .Mainbody_conatiner .Mainbody_content .card .card-body .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content h6 {
        font-size: 4vmin;
    }

    .Mainbody_conatiner .Mainbody_content .card .card-body .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content p {
        font-size: 4vmin;
    }

    .Mainbody_conatiner .Mainbody_content .card .card-body .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content input {
        font-size: 4vmin;
    }

    .Mainbody_conatiner .Mainbody_content .card .card-body .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content span {
        font-size: 4vmin;
    }
...
.perunding_tableContent {
    font-size: 0.8rem;
    text-align: center;
}

.perunding_SenaraiMasalah {
    justify-content: right;
}
...
.tab_icon_lite_yellow {
    font-size: 1em;
    color: #FFC35A;
}

.Table_perunding_span {
    background-color: #39AFD1;
    color: #fff;
    font-size: 0.8rem;
}

.Table_perunding_header {
    background-color: #39AFD1;
    color: #fff;
    font-size: 0.8rem;
}

.Table_perunding_header_new {
    color: #151414;
    font-size: 0.8rem;
}

h5#modalSpPopUpLabel {
    font-size: .8rem !important;
}

.Table_perunding_body {
    font-size: 0.8rem;
}
...
.table_footer ul ul li {
    padding: 0.3rem 0.9rem;
}

.table_footer ul ul li.active {
    color: #fff;
    background-color: #659dd8;
}
...
.vmsimpan {
    background-color: #5b64c3 !important;
...
.modalEotLad .modal-dialog .modal-content .Table_perunding_body table thead tr th,
.modalEotLad .modal-dialog .modal-content .Table_perunding_body table thead tr th button,
.modalEotLad .modal-dialog .modal-content .Table_perunding_body table tbody tr td {
    font-size: 0.8rem;
}
...
.modal-body.Table_perunding_body {
    padding-left: 2%;
    padding-right: 2%;
}
.nageri_union {
