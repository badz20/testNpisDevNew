...
.searchIn{
        background:url("{{ asset('assets/images/Icon Cari.png') }}") no-repeat calc(100% - 200px) center / 15px ;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tbody tr:last-child td {
  font-weight: 600;
  background-color: #39b0d2;
  position: relative;
  z-index: 1;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tbody tr:last-child td:last-child {
  border-radius: 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tbody tr:last-child td input {
  background-color: #d9d9d9;
  padding: 0.3rem;
  border-radius: 2.5rem;
}
...
.papar_senarai {
  ...
  margin-top: auto;
    ...
    .project_register_form_modal_container #Priority_set_model{
      background-color: rgba(0, 0, 0, 0.2);
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog {
      max-width: 43%;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content {
      padding: 4.5% 4%;
      border-radius: 10px;
      background-color: #fff;
      border: none;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body{
      width: 100%;
      background-color: #fff;
      margin: auto;
      padding: 0;
    ...
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_header {
      display: flex;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_header button{
      background-color: transparent;
      border: none;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content{
      padding: 2%;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content h3.success_header{
      margin-bottom: 7%;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content h3 {
      font-size: 1.35rem;
      font-weight: 600;
      text-align: center;
      margin: 4% 0 10% 0;
    ...
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content h3.vms{
      color: #ff3f40;
      font-size: 1.1rem;
      margin-bottom: 2%;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content h2 {
      font-family: Poppins_bold;
      text-align: center;
      font-size: 1.8rem;
      padding: 2% 0 3%;
    ...
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content .btn_holder{
      align-items: center;
      justify-content: center;
      gap: 2%;
    }
    
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content button.fix_button{
      margin: 2% 0 3% 0;
      background-color: #5b64c3;
      color: #fff;
      border: none;
    ...
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content button.fix_button.red{
      background-color: #dc3745;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content button.fix_button.green{
      background-color: #4da84b;
    }
    .project_register_form_modal_container #Priority_set_model .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content button.fix_button.blue{
      background-color: #1a7df4;
    }

    /* 2023 Sept 11 by Nabilah */
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holder .application_list tbody tr td:nth-child(4) {
  white-space: nowrap!important;
}

button.pemberat_greenBtn_new.mt-2 {
    float: right;
    margin-right: 6px;
    width: 5%;
    border: 0px;
