...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form select[disabled] {
    -webkit-appearance: none;
    -moz-appearance: none;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form .cari {
  padding: 0.7% 1.8%;
  background-color: #5B63C3;
  color: #fff;
  width: 8%;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .project_register_table_header .dropdown_menu .dropdown-item img.excel {
  max-width: 100%;
  height: auto;
  margin-right: 0px;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holdertable_preview {
  font-size: 0.78rem;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form .reset {
  padding: 0.7% 1.8%;
  background-color: #FA5C7C;
  color: #fff;
  font-size: 0.8rem;
...
/* 2023 April 13 by Nabilah */
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holder .application_list tbody tr td {
    border-top: 1px solid #dee2e6;
    padding: 0.78rem;
    font-size: 0.75rem;
    color: #818390;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holder .application_list tbody tr:nth-child(odd) td:nth-child(4) {
  background-color: #f5f6fa;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holder .application_list tbody tr:nth-child(even) td:nth-child(4) {
  background-color: #fff;
}
