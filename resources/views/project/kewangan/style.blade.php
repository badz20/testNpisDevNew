<style>
  ...
  /* for strategi modal */
  .add_rmk_data_modal_container #add_rmk_data_modal {
  background-color: rgba(0, 0, 0, 0.2);
}
.add_rmk_data_modal_container #add_rmk_data_modal .add_rmk_data_modal_dialog {
  max-width: 45%;
}
.add_rmk_data_modal_container #add_rmk_data_modal .add_rmk_data_modal_dialog .add_rmk_data_modal_content .add_rmk_data_modal_header {
  background-color: #ffffff;
  padding-left: 2%;

}
.add_rmk_data_modal_container #add_rmk_data_modal .add_rmk_data_modal_dialog .add_rmk_data_modal_content .add_rmk_data_modal_header h5 {
  font-size: 0.89rem;
  color: rgb(0, 0, 0);
  margin: 0;
  padding-left: 0.5rem;
...
.add_rmk_data_modal_container #add_rmk_data_modal .add_rmk_data_modal_dialog .add_rmk_data_modal_content .add_rmk_data_modal_body {
  background-color: #f5f6fc;
}
.add_rmk_data_modal_container #add_rmk_data_modal .add_rmk_data_modal_dialog .add_rmk_data_modal_content .add_rmk_data_modal_body form label {
  font-size: 0.8rem;
  color: #757ca5;
  font-weight: 600;
}
.add_rmk_data_modal_container #add_rmk_data_modal .add_rmk_data_modal_dialog .add_rmk_data_modal_content .add_rmk_data_modal_body form input {
  height: auto;
  font-size: 0.88rem;
}
.add_rmk_data_modal_container #add_rmk_data_modal .add_rmk_data_modal_dialog .add_rmk_data_modal_content .add_rmk_data_modal_header button {
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table thead {
  background-color: #39b0d2;
}
...
.NPIS_Container .navbar_background {
  background-color: #30838f !important;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody td input[readonly] {
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan tbody tr td input[readonly] {
  background-color: #f4f4f4;
  text-align: end;
  padding: 0.5rem;
  border: none;
...
.projek_table_kewagan tbody tr:last-child td {
    font-weight: 600;
    background-color: #39b0d2;
    position: relative;
    z-index: 1;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr td input[readonly] {
  background-color: #f4f4f4;
  text-align: end;
  padding: 0.5rem;
  /* border: none; */
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan .perkara_table_sec_kewagan {
  width: 100%;
  height: auto;
  border: 2px solid #707070;
  border-bottom: none;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan .perkara_table_sec_kewagan thead {
  font-family: Poppins_bold;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan .perkara_table_sec_kewagan thead tr {
...
.newfinancesectiontable tr td{
  border: none;
  
}

.perkara_table_sec_kewagan thead tr th {
  padding: 0.9rem 1rem;
  color: #000;
  font-size: 0.75rem;
  border: none;
...
.perkara_table_sec_kewagan tr td input {
  background-color: #fff;
  text-align: end;
  padding: 0.3rem;
  border-radius: 2.5rem;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container tbody tr td input {
  background-color: #fff;
  text-align: end;
  padding: 0.3rem;
  border-radius: 2.5rem;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan .perkara_table_sec_kewagan tbody tr:last-child td {
  font-weight: 600;
  background-color: #39b0d2;
  position: relative;
  z-index: 1;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan  .perkara_table_sec_kewagan tbody tr:last-child td:last-child {
  border-radius: 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan .perkara_table_sec_kewagan tbody tr:last-child td input {
  background-color: #d9d9d9;
  padding: 0.3rem;
  border-radius: 2.5rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_sec_kewagan  .perkara_table_sec_kewagan tbody tr td p {
  font-size: 0.75rem;
}
...
.perkara_table_kewagan tbody tr:last-child td {
  background-color: #39b0d2;
  border: 2px solid #39b0d2;
}
table#perkara_table_kewagan {
  width:100%;
}

/* 2023 March 09 by Nabilah */
@media (max-width: 820px) {
  .nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content label {
    margin: 0;
    width: 100%;
    font-size: 4vmin;
  }
  .nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content p {
    text-align: justify;
    font-size: 4vmin;
  }
  ...
  .perkara_table_kewagan tr td input {
    background-color: #fff;
    text-align: end;
    padding: 0.3rem;
    border-radius: 2.5rem;
  ...
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container .components_table tr td input {
    width: 8rem;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr td:nth-child(2) input {
    background-color: #d9d9d9;
