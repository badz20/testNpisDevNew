...
<script>
    $(document).ready(function () {  
      ...
      $("div.overlay").addClass("show");
       ...
       const api_token = "Bearer "+ window.localStorage.getItem('token');
        ...
        axios({
        method: 'get',
        url: api_url+"api/project/get-pengesahan-project-list?id="+user_id+"&usertype="+user_type+"&userRole="+userRole+"&penyemak="+penyemak+
    ...
    function HantarProject()
    {
       ...
       var all_susunan  = document.querySelectorAll(".pengesah_priority_input"); console.log(all_susunan);
