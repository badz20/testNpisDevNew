    ...
    let all_negeri_btn = document.querySelectorAll(
                ...
                all_negeri_btn.forEach((tb, i) => {                    
                    tb.addEventListener("click", () => {
                        ...
                        let all_negeri_btn_1 = document.querySelectorAll(
                    "[id='minus_button']"                    
                );   
                console.log(all_negeri_btn_1);              
                    });
                });
});
...
function show_addbtn(rdovalue){
    ...
    //****************************************************************/
     ...
     //Add the styling to point layer
        ...
        const url_feature = "https://npisgis.water.gov.my/arcgis/rest/services/Permohonan/Lakaran_Permohonan_Polygon/FeatureServer/0";
		    const PolygonFeature = new FeatureLayer({
          url: url_feature,
          outFields: ["*"],
          id: "auidd",
