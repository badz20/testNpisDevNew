...
const addBtn = document.getElementById("addbtndiv");
    ...
    addBtn.addEventListener("click", () => {
      ...
      //***********************Jey's Code******************************************************************
      <?php
        $token_url = 'https://npisportal.water.gov.my/arcgis/sharing/rest/generateToken';
        $data = array(
          'username' => 'devportal',	//portal username
          'password' => 'devportal_123', //portal password
          'client' => 'referer',
          'referer' => 'https://npis.swefss.com',
          'expiration' => '500', //token duration in minnutes
          'f' => 'json'
        );

        $token_response = sendPostRequest($token_url, $data);
    ...
    ?>
		  ...
		  // Set the API key
		//esriConfig.apiKey = "AAPK762b5033df35405680db269441a65e59p6q-QuHpqIMNGmQq1QbK_pPzlMyBSavDBQL1QcOoGt2OTKbA2P0jqqbjsk1kPr_Y";
      ...
      esriConfig.apiKey = "AAPKf49418ab6f204def9460df6565e9f552e9xa7tdpLgOEKskndzbLnpNn49OLB4PQpdGtHtg_CnMLLqn01T2xyIYNLJhOIPen";
    ...
    //****************************************************************/
     ...
     //Add the styling to point layer
        ...
        sketchpolygon.on("redo", function(event){
          ...
          editFeaturepoly.attributes["No_Rujukan_Permohonan"] = document.getElementById("polynorujukan").value;
          ...
          editFeaturepoly.attributes["Nama_Projek"] = document.getElementById("polynamaprojek").value;
          ...
          if (document.getElementById("ArcgisSatellite").style.cursor != "crosshair") {
            ...
            .then((results) => {
              if (results.features.length > 0) {
                ...
                document.getElementById("polytahun").value = results.features[0].attributes['Tahun_Permohonan'];
                document.getElementById("polyjenis").value = results.features[0].attributes['Jenis_Permohonan'];
                document.getElementById("polynorujukan").value = results.features[0].attributes['No_Rujukan_Permohonan'];
                document.getElementById("polykomponenkerja").value = results.features[0].attributes['Komponen_Kerja'];
                document.getElementById("polyluas").value = results.features[0].attributes['Luas'];
                document.getElementById("polynamakomponen").value = results.features[0].attributes['Nama_Komponen'];
                document.getElementById("polynamaprojek").value = results.features[0].attributes['Nama_Projek'];
  ...
  const LineFeature = new FeatureLayer({
        ...
        sketchline.on("update",function(event){
          ...
          if (
            ...
            editFeatureLine.attributes["Tahun_Permohonan"] = document.getElementById("linetahun").value;
            editFeatureLine.attributes["Jenis_Permohonan"] = document.getElementById("linejenis").value;
            editFeatureLine.attributes["Komponen_Kerja"] = document.getElementById("linekomponenkerja").value;
            editFeatureLine.attributes["No_Rujukan_Permohonan"] = document.getElementById("linenorujukan").value;
            editFeatureLine.attributes["Panjang"] = parseFloat(document.getElementById("linepanjang").value);
            editFeatureLine.attributes["Nama_Komponen"] = document.getElementById("linenamakomponen").value;
            editFeatureLine.attributes["Nama_Projek"] = document.getElementById("linenamaprojek").value;
          ...
          if (document.getElementById("ArcgisSatellite").style.cursor != "crosshair") {
            ...
            .then((results) => {
              if (results.features.length > 0) {
                ...
                document.getElementById("linetahun").value = results.features[0].attributes['Tahun_Permohonan'];
                document.getElementById("linejenis").value = results.features[0].attributes['Jenis_Permohonan'];
                document.getElementById("linenorujukan").value = results.features[0].attributes['No_Rujukan_Permohonan'];
                document.getElementById("linekomponenkerja").value = results.features[0].attributes['Komponen_Kerja'];
                document.getElementById("linepanjang").value = results.features[0].attributes['Panjang'];
                document.getElementById("linenamakomponen").value = results.features[0].attributes['Nama_Komponen'];
                document.getElementById("linenamaprojek").value = results.features[0].attributes['Nama_Projek'];
