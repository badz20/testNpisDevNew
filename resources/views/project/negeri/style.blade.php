...
#menu-item{
  transform: translate3d(-115px, 38px, 0px) !important;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_form_group select {
  height: auto;
  font-size: 0.8rem;
  padding: 0.65rem 1rem;
  border-radius: 0.2rem;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_form_group select:focus {
  outline: none;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_form_group select {
  background-repeat: no-repeat;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_form_group select option {
  font-size: 0.8rem;
}
/* End by Nabilah */
