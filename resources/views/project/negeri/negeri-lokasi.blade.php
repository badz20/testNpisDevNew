...
<x-form.spinner>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content" style="width: 65em;">
                        ...
                        <div class="modal-body d-flex">
                         <ul>
                          <h6><b>KOMPONEN KERJA POINT</b></h6>
                          <li class="listPoint">Pump house</li>
                          <li class="listPoint"> Tidal control gate</li>
                          <li class="listPoint">Flap gate</li>
                          <li class="listPoint"> Medium traffic bridge (MTB)</li>
                          <li class="listPoint">Dam</li>
                          <li class="listPoint">Hydrological Station</li>
                          <li class="listPoint"> Barrage</li>
                          <li class="listPoint"> Bridge</li>
                          <li class="listPoint"> Building</li>
                          <li class="listPoint"> Crossing</li>
                          <li class="listPoint"> Tube well</li>
                          <li class="listPoint"> Outlet structure</li>
                          <li class="listPoint"> TNB substation</li>
                          <li class="listPoint"> Weir & Drop structure</li>
                          <li class="listPoint"> Main Dam</li>
                          <li class="listPoint"> Saddle Dam</li>
                          <li class="listPoint"> Spillway</li>
                          <li class="listPoint"> Water intake tower</li>
                          <li class="listPoint"> Control Gate</li>
                          <li class="listPoint"> Log boom</li>
                          <li class="listPoint"> Gross pollutant trap (GPT)</li>
                          <li class="listPoint"> River Water treatment plant (RWTP)</li>
                          <li class="listPoint"> Jetty</li>
                          <li class="listPoint"> Draw Off Tower</li>
                          <li class="listPoint"> Waste Water Treatment Plan (WWTP)</li>
                          <li class="listPoint"> Trash rake</li>
                          <li class="listPoint"> Sediment trap</li>
                          <li class="listPoint"> Tidal Station</li>
                          <li class="listPoint"> Headwork</li>
                          <li class="listPoint"> Flume</li>
                          <li class="listPoint"> Orifice</li>
                          <li class="listPoint"> Siphon</li>
                          <li class="listPoint"> Swirl</li>
                          <li class="listPoint"> Drainage End Control (DEC)</li>
                          <li class="listPoint"> Irrigation End Control (IEC)</li>
                          <li class="listPoint"> Constant Head Orifice(CHO)</li>
                          <li class="listPoint"> Intake Structure</li>
                          <li class="listPoint"> WaterTreatment Plan (WTP)</li>
                          <li class="listPoint"> Check Dam</li>
                          <li class="listPoint"> Wave Attenuator Structure</li>
                          <li class="listPoint"> Viaduct Tunnel</li>
                          <li class="listPoint"> Tower Bridge</li>
                          <li class="listPoint"> Outlet Tunnel</li>
                          <li class="listPoint"> Suction Tank</li>
                          <li class="listPoint"> Elevation water tank</li>
                          <li class="listPoint"> Control Structure</li>
                          <li class="listPoint"> Pesture</li>
                         </ul>
                         <ul>
                          <h6><b>KOMPONEN KERJA POLYLINE</b></h6>
                          <li class="listPoint">Bund</li>
                          <li class="listPoint">River improvement</li>
                          <li class="listPoint">Riverbank protection</li>
                          <li class="listPoint">River diversion</li>
                          <li class="listPoint">Collector Drain</li>
                          <li class="listPoint">Main drain</li>
                          <li class="listPoint">Beach nourishment</li>
                          <li class="listPoint">Breakwater (struktur pemecah ombak)</li>
                          <li class="listPoint"> Dredging</li>
                          <li class="listPoint"> Bypass channel</li>
                          <li class="listPoint"> Flood wall</li>
                          <li class="listPoint"> Groyne</li>
                          <li class="listPoint"> Main canal</li>
                          <li class="listPoint"> Secondary canal</li>
                          <li class="listPoint"> Tertiary canal</li>
                          <li class="listPoint"> Maintenance road/ Plantation Road</li>
                          <li class="listPoint"> Road</li>
                          <li class="listPoint"> Safety Railing</li>
                          <li class="listPoint"> Safety Fence</li>
                          <li class="listPoint"> Tunnel</li>
                          <li class="listPoint"> Retaining wall</li>
                          <li class="listPoint"> Marine Outfall</li>
                          <li class="listPoint"> Rock Revertment</li>
                          <li class="listPoint">Nearshore Breakwater</li>
                          <li class="listPoint"> Offshore Breakwater</li>
                          <li class="listPoint"> Training Wall</li>
                          <li class="listPoint"> Boardwalk</li>
                          <li class="listPoint"> Water Reticulation System</li>
                         </ul>
                         <ul>
                          <h6><b>KOMPONEN KERJA POLYGON</b></h6>

                          <li class="listPoint">Pond</li>
                          <li class="listPoint"> Flood area</li>
                          <li class="listPoint">Land acquisition & perizaban</li>
                          <li class="listPoint"> Underground Storage</li>
                          <li class="listPoint">Padang Ragut (Pasture)</li>
                         </ul>
                        </div>
                                ...
                                <div class="col-12" id="attributeArea">
                                  <div id="formDiv">
                                    <div class="row">
                                      ...
                                      <div class="form-group col-12">
                                        <label for="pointnorujukan">No Rujukan Permohonan</label>
                              ...
                              <div id="attributeArealine" class="col-12">
                                <div id="formDivline">
                                  <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                      <label for="linenorujukan">No Rujukan Permohonan</label>
                              ...
                              <div class="col-12" id="attributeAreapoly">
                                <div id="formDivpoly">
                                  <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                      <label for="polynorujukan">No Rujukan Permohonan</label>
  ...
  <section>
    <div class="user_profile_footer m-0 P-3" style="display: flex; align-items: center; position:absolute; top:3600;">
      <span>{{ now()->year }}</span>
...
window.initMap = initMap;
 ...
 <script>
  ...
  //     apikey: apiKey, // provide either apikey or token
  //     version: 1 // this property is optional
  // }).addTo(map);
