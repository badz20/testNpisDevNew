...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_con tainer .components_table_container table thead {
  background-color: #39b0d2;
}
...
.nageri_container .nageri_right_content .select_box_header {
  width: 96%;
  margin-left: 1.5%;
  font-size: 1rem;
  font-weight: 600;
...
.nageri_container .nageri_right_content .project_register_table_header {
  display: flex;
  padding: 1% 3% 1% 2%;
  margin-top: 3.8%;
  align-items: center;
...
.nageri_container .nageri_right_content .project_register_table_header button{
  font-size: 0.88rem;
  color: #6C7293;
  padding: 0.5% 1%;
  border: none;
...
.nageri_container .nageri_right_content .project_register_table_header button.blue {
  background-color: #38afd1;
}
.nageri_container .nageri_right_content .project_register_table_header button .arr_bottom {
  margin-top: -12%;
}
.nageri_container .nageri_right_content .project_register_table_header .dropdown_menu  {
  border: 1px solid #9bc2e8;
  width: 12%;
  padding: 1%;
}
.nageri_container .nageri_right_content .project_register_table_header .dropdown_menu .dropdown-item img.pdf {
  width: 1rem;
  margin: 0.2rem;
}
...
.NPIS_Container .navbar_background {
  ...
  /* This page CSS */
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container {
    margin-top: 0%;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container h3.table_heading {
    font-size: 0.9rem;
    margin: 0 0 2% 0;
    font-family: Poppins_bold;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table th,
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table td {
    font-size: 0.75rem;
    color: #000;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table thead tr {
    background-color: #39b0d2;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table thead th {
    border: 2px solid #d9d9d9;
    vertical-align: middle;
    color: #fff;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table thead th.borders {
    border-bottom: 1px solid #dee2e6;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table tbody th {
    border: 2px solid #d9d9d9;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table tbody tr td:nth-child(1) {
    padding-left: 2%;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table tbody tr td:nth-child(1) input {
    background-color: transparent;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table tbody td {
    font-family: Poppins_bold;
    vertical-align: middle;
    padding: 0.3rem;
    border: 2px solid #d9d9d9;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table tbody td button img {
    width: 16px;
    aspect-ratio: 1/1;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table tbody td p {
    margin: 0;
    font-size: 0.75rem;
    color: #000;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table tbody td input {
    background-color: #d9d9d9;
    border-radius: 0;
    font-size: 0.75rem;
    font-family: Poppins_Regular;
  ...
  .Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .nageri_form_content .nageri_select_box .ringkasan_container .input_fill_content .components_table_container table tbody td button {
    background-color: transparent;
    border: none;
  } 
  .input_fill_content {
    ...
    display: flex;
      ...
      .input_fill_satellite_content {
    float: right;
   
  }
      .input_fill_satellite_content .img_div_1{
        margin-right:50px;
   
  }
      .input_fill_satellite_content .img_div_2{
        margin-right:50px;
   
  }
      .input_fill_satellite_content .img_div_3{
        margin-right:40px;
   
  }
      .input_fill_satellite_content .img_1{
        width:300px;
   
  }
      .input_fill_satellite_content .img_2{
        width:300px;
   
  }
      .input_fill_satellite_content .img_3{
        width:300px;
...
.input_fill_content .skop_card_content .skop_footer input {
  ...
  .komponen_three_table tbody tr td input {
...
.projek_table {
  ...
  .projek_table tbody tr td input {
    background-color: #f5f5f5;
    text-align: end;
    padding: 0.5rem;
    border: none;
  ...
  .projek_table tbody tr:last-child td input {
    background-color: #d9d9d9;
    border-radius: 0rem;
  }
  ...
  .perkara_table_sec_kewagan tbody tr td {
    font-size: 16px;
    padding: 10px;
    position: relative;
    z-index: 1;
  ...
  .perkara_table tbody tr td input {
    background-color: #fff;
    text-align: end;
    padding: 0.3rem;
    /* border-radius: 2.5rem; */
  ...
  .perkara_table_sec_kewagan thead{
    background-color: #39b0d2;
  }
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .input_container .input_fill_content button.green {
  ...
  img#img_negeri_2, img#img_negeri_1, img#img_negeri_3 {
    width:50% !important;
    height:auto% !important;
}
#objektif ol li p span, #objektif ol li div span,
#ringkasan-data ol li p span, #ringkasan-data ol li div span,
#rasional ol li p span, #rasional ol li div span,
#faedah ol li p span, #faedah ol li div span,
#implikasi ol li p span, #implikasi ol li div span {
