...
.Mainbody_conatiner .VAE-page .acquistion-topic .acquistion-topic-G {
font-size: 0.9rem;
font-style: italic;
font-weight: 600;
padding-bottom: 1%;
...
@media (min-width: 821px) {
  ...
  .Mainbody_conatiner .VAE-page .daya-accordion .card-body-strategi {
  display: flex;
  align-items: center;
  justify-content: center;
  padding: 5px 0 5px;
...
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt {
  ...
  .Mainbody_conatiner .VAE-page .vae_acc_6_conetnt table {
    width: 100%;
  }
}
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .project_register_table_header button{
  font-size: 0.88rem;
  color: #6C7293;
  padding: 0.5% 1%;
  border: none;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .project_register_table_header button.blue {
  background-color: #38afd1;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .project_register_table_header button .arr_bottom {
  margin-top: -12%;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .project_register_table_header .dropdown_menu  {
  border: 1px solid #9bc2e8;
  width: 12%;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .project_register_table_header .dropdown_menu .dropdown-item img.pdf {
  width: 1rem;
  margin: 0.2rem;
}
/* End by Nabilah */
