...
p#file_size, #file_type, p#gambar_image_error {
  padding-left: 13.5%;
  color:red;
}
div#image_preview_1 {
...
.dokumen_right_content .dokumen_form .dokumen_tables tbody td sup{
  font-size: 0.9rem;
  color: red;
}
...
p#file_size,p#file_type, .error {
  color:red;
}
.dokumen_body_table {
  width:85% !important;
}
.img_input_container.position-relative{
  width:130%;
}
button.btn.mx-auto.modal_btn {
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .input_container .input_fill_content button.green {
  ...
  /* End by Nabilah */
  div#upload_logo_1, #upload_logo_2{
    padding: 3% 0;
    text-align: center;
    color: #6c757c;
    border: 1px dashed #8c979d;
