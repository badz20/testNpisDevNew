...
/* 2023 March 21 by Nabilah (Increase and centered modal box for responsive) */
@media (max-width: 820px) {
...
.Tambah_modal_container #Tambah_data_modal, #Tambah_data_modal_edit {
  background-color: rgba(0, 0, 0, 0.2);
}

@media screen and (max-width: 576px) {
  .Tambah_modal_container #Tambah_data_modal .Tambah_modal_dialog ,.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog,
  .Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog ,.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog {
    padding: 2% 0;
    width: 90%;
    margin: auto;
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_header {
  padding: 2%;
  width: 95%;
  margin: auto;
  border-bottom: 1px solid #ced4da;
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_header h5 {
  font-size: 0.89rem;
  font-family: Poppins_bold;
}
.Tambah_modal_container #Tambah_data_modal .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_header button ,
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_header button {
  background-color: transparent;
  border: none;
}
.Tambah_modal_container #Tambah_data_modal .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body,
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body {
  padding: 1% 4%;
}
.Tambah_modal_container #Tambah_data_modal .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body p.box,
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body p.box {
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form input,
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form select {
  height: auto;
  padding: 0.6rem 1rem;
  font-size: 0.88rem;
}
.Tambah_modal_container #Tambah_data_modal .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form textarea,
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form textarea {
  height: 5rem;
  border-bottom-right-radius: 0;
}
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form .tambah_table_container table thead {
  background-color: #39aed1;
}
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form .tambah_table_container table thead th,
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form .tambah_table_container table thead tr {
  border: none;
  color: #fff;
  font-size: 0.8rem;
  text-align: center;
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form .tambah_table_container table tbody tr {
  border: 1px solid #ced4da;
}
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form .tambah_table_container table tbody td {
  padding: 0.4rem 0;
}
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form .tambah_table_container table tbody .form-group {
  margin: 0;
}
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body form .tambah_table_container table tbody input {
  width: 80px;
  box-shadow: none;
  margin: auto;
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body .Tambah_modal_footer {
  margin: 3% 0 3% 0;
}
...
.Tambah_modal_container #Tambah_data_modal_edit .Tambah_modal_dialog .Tambah_modal_content .Tambah_modal_body .Tambah_modal_footer button  {
  color: #fff;
  background-color: #5b63c3;
  border: none;
  font-size: 0.8rem;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .input_container .input_fill_content button.green {
  ...
  .add_role_sucess_modal_container #add_role_sucess_modal-confirm .add_role_sucess_modal_dialog .add_role_sucess_modal_content .add_role_sucess_modal_header button ,
  .project_register_form_modal_container #vms_modal .project_register_form_modal_dialog .project_register_form_modal_header button,
  .add_role_sucess_modal_container #add_role_sucess_modal .add_role_sucess_modal_dialog .add_role_sucess_modal_content .add_role_sucess_modal_header button {
    background-color: transparent;
    border: none;
    padding: 2%;
  }
