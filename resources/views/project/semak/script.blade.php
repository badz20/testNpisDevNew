    ...
    $(document).ready(function () {  
      ...
      $("div.overlay").addClass("show");
       ...
       const api_token = "Bearer "+ window.localStorage.getItem('token');
        ...
        var peraku =  {{$peraku}}; console.log(peraku)
        ...
        axios({
        method: 'get',
        url: api_url+"api/project/get-semak-project-list?id="+user_id+"&usertype="+user_type+"&userRole="+userRole+"&penyemak="+penyemak+
                                                        "&penyemak_1="+penyemak_1+"&penyemak_2="+penyemak_2+"&pengesah="+pengesah+"&peraku="+peraku,
        responseType: 'json'
        })
                      ...
                      render: function ( data, type, row, meta ) {                  
                        if(type === 'display'){  
                           ...
                           {      
                              ...
                              {
                                data = '<td class="d-flex align-items-center susunan_'+row.id+'">' +    
                                  `<input  style="border-color:#2dc23a;" type="text" class="priority_input" id="pengesha_priority0_`+row.id+`" size="2" min="1" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" title="Sila klik di luar untuk menyimpan keutamaan" onfocusout="SetPengasahPriority('0',`+row.id+`,`+row.tahun+`)" placeholder="" value="`+row.pengesha_priority_order+`">`                            
                                  '</td>'
                              } 
                              else
                              {
                                data = '<td class="d-flex align-items-center susunan_'+row.id+'">' +    
                                  `<input style="border-color:#FFC35A;" type="text" class="priority_input" id="pengesha_priority1_`+row.id+`" size="2" min="1" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" title="Sila klik di luar untuk menyimpan keutamaan" onfocusout="SetPengasahPriority('1',`+row.id+`,`+row.tahun+`)" placeholder="" value="">`                            
                                  '</td>'                                
                              }               
                           }
                           else
                           {
                              ...
                              {
                                data = '<td class="d-flex align-items-center susunan_'+row.id+'">' +    
                                  `<input disabled style="border-color:#2dc23a;" type="text" class="priority_input" value="`+row.pengesha_priority_order+`">`                            
                                  '</td>'
                              } 
                              else
                              {
                                data = '<td class="d-flex align-items-center susunan_'+row.id+'">' +    
                                  `<input disabled style="border-color:#FFC35A;" type="text" class="priority_input" value="0">`                            
                                  '</td>'
                              }  
                           }
                          }
                      ...
                      render: function ( data, type, row, meta ) {                  
                        if(type === 'display'){  
                           ...
                           {      
                              ...
                              {
                                data = '<td class="d-flex align-items-center susunan_'+row.id+'">' +    
                                  `<input  style="border-color:#2dc23a;" type="text" class="priority_input" id="peraku_priority0_`+row.id+`" size="2" min="1" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" title="Sila klik di luar untuk menyimpan keutamaan" onfocusout="SetPerakuPriority('0',`+row.id+`,`+row.tahun+`)" placeholder="" value="`+row.peraku_priority_order+`">`                            
                                  '</td>'
                              } 
                              else
                              {
                                data = '<td class="d-flex align-items-center susunan_'+row.id+'">' +    
                                  `<input style="border-color:#FFC35A;" type="text" class="priority_input" id="peraku_priority1_`+row.id+`" size="2" min="1" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" title="Sila klik di luar untuk menyimpan keutamaan" onfocusout="SetPerakuPriority('1',`+row.id+`,`+row.tahun+`)" placeholder="" value="">`                            
                                  '</td>'                                
                              }               
                           }
                           else
                           {
                              ...
                              {
                                data = '<td class="d-flex align-items-center susunan_'+row.id+'">' +    
                                  `<input disabled style="border-color:#2dc23a;" type="text" class="priority_input" value="`+row.peraku_priority_order+`">`                            
                                  '</td>'
                              } 
                              else
                              {
