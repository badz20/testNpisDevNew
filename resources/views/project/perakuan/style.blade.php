...
.perakuan_content_vertical .perakuan_tables .vertical_perakuan label {
    color: #212529;
    font-size: 14px;
    font-family: Poppins_Bold;
  }

  .perakuan_content_vertical .perakuan_tables .vertical_perakuan span  {
    color: #212529;
    font-size: 14px;
    font-family: Poppins_Regular;
  }
  ...
  .project_register_form_modal_container #Make_sure_application_modal .project_register_form_modal_dialog .project_register_form_modal_content .project_register_form_modal_body .project_register_form_modal_body_Content button{
