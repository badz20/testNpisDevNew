...
.side_bar_Container {
  ...
  background: linear-gradient(180deg, #74d6b9 0%, rgba(94, 183, 156, 0) 83.72%), #577dc6;
  overflow: hidden;
}
...
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content {
  padding: 0.8rem 0.4rem;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .sidebar_icon {
  width: 10%;
  cursor: pointer;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list {
  width: 100%;
  padding-left: 0.8rem;
  opacity: 1;
  left: 0;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .Accordian-header {
  align-items: center;
  padding: 0rem 0.4rem;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .Accordian-header a.Accordian_link {
  display: block;
...
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .Accordian-header a.Accordian_link .sidebar_icon_Container .sidebar_icon_right_content {
  width: 100%;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .Accordian-header a.Accordian_link .sidebar_icon_Container .sidebar_icon_right_content .sb_contents {
  align-items: center;
  justify-content: space-between;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .Accordian-header a.Accordian_link .sidebar_icon_Container .sidebar_icon_right_content .sb_contents p {
  padding-top: 0.3rem;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .Accordian-header a.Accordian_link .sidebar_icon_Container .sidebar_icon_right_content .sb_contents .d_arrow {
  transform: rotate(270deg);
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .Accordian-header a.Accordian_link .sidebar_icon_Container .sidebar_icon_right_content .sb_contents .d_arrow.active {
  transform: rotate(0);
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .Accordian-header a.Accordian_link p {
  margin: 0;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .accordian_collapse_list ul {
  padding: 0 0.35rem;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .accordian_collapse_list ul li:nth-child(1) a {
  padding-top: 1rem;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .accordian_collapse_list ul li a {
  text-decoration: none;
  display: block;
  padding: 0.3rem 0;
  font-size: 0.86rem;
...
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .accordian_collapse_list ul li a:hover {
  font-weight: 600;
}
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list.active {
  width: 0%;
  height: 0;
  overflow-x: hidden;
}
...
.side_bar_Container.Project_application {
  background: linear-gradient(180deg, #28877f 0%, rgba(94, 183, 156, 0) 83.72%), #245ea4;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container {
  width: 97%;
  margin: auto;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_box_container :nth-child(1) .project_register_box_content {
  background: #5fade7;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_box_container :nth-child(2) .project_register_box_content {
  background: #aca2f9;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_box_container :nth-child(3) .project_register_box_content {
  background: #73e8a6;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_box_container :nth-child(4) .project_register_box_content {
  background: #f0cc8a;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_box_container .content_unique_image {
  margin-top: 2%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_box_container .content_unique_image .tick {
  top: 25%;
  right: -25%;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container {
  background-color: #e9edf6;
  padding: 1%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_header {
  gap: 3%;
  align-items: center;
  margin-bottom: 2%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_header p.square {
  width: 2.5%;
  aspect-ratio: 1/0.8;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_header h4 {
  margin: 0;
  text-transform: uppercase;
  color: #6e7180;
  font-size: 1rem;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container {
  width: 97%;
  margin: auto;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form label {
  margin: 0;
  font-size: 0.8rem;
  color: #212529;
  font-weight: 600;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form .custom_width {
  width: 12%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form input,
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form select {
  height: auto;
  font-size: 0.8rem;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form .form-group {
  margin: 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form .submit {
  margin: 1.5% 0 0.5% 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_search_container .project_register_search_form_container form .submit button {
  padding: 0.7% 1.8%;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .project_register_table_header button.blue {
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .project_register_table_header button .arr_bottom {
  margin-top: -12%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .project_register_table_header .dropdown_menu {
  border: 1px solid #9bc2e8;
  width: 12%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .project_register_table_header .dropdown_menu .dropdown-item img.pdf {
  width: 1rem;
  margin: 0.2rem;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holder .table_preview.application_list tbody tr:nth-child(odd) {
  background-color: #f5f6fa;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_holder .table_preview.application_list tbody tr.empty:last-child {
  background-color: #f5f6fa;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_footer {
  width: 97%;
  margin: auto;
  justify-content: space-between;
  font-size: 0.9rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_footer p {
  color: #9ba2a9;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_footer ul {
  font-weight: 600;
  padding: 0;
  display: flex;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_footer ul li {
  display: flex;
  align-items: center;
  border-radius: 50%;
  cursor: pointer;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_footer ul ul {
  gap: 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_footer ul ul li {
  padding: 0.3rem 0.9rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .project_register_table_container .table_footer ul ul li.active {
  color: #fff;
  background-color: #659dd8;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container {
  width: 97%;
  margin: auto;
  background-color: #fff;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content_header {
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding: 0.2% 1% 0.2% 1%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content_header button {
  border: none;
  width: 3.5%;
  background-color: transparent;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content_header button img {
  width: 100%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content_header h4 {
  font-size: 1rem;
  font-family: Poppins_bold;
  margin: 0;
  text-transform: uppercase;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content_header h4 img {
  width: 8%;
  margin-right: 2%;
}
@media (min-width: 821px) {
  .Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content {
    display: flex;
    width: 100%;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_left_content_container {
    width: 52%;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_left_content_container .iframe_holder {
    padding: 0.8%;
    height: 65vh;
    border: 1px solid #f6f6f6;
  }
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_left_content_container .iframe_holder iframe {
  width: 100%;
  height: 100%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_left_content_container .iframe_btn_container {
  display: flex;
  gap: 1%;
  margin-top: 1%;
  padding: 0.8%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_left_content_container .iframe_btn_container button {
  font-size: 0.8rem;
  text-transform: uppercase;
  font-family: Poppins_bold;
  border: none;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_left_content_container .iframe_btn_container button:nth-child(1) {
  background-color: #22a21a;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_left_content_container .iframe_btn_container button:nth-child(2) {
  background-color: #dacc38;
}
@media (min-width: 821px) {
  .Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container {
    width: 48%;
    padding: 0 1%;
  }
  .Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_top_content_container {
    height: 31%;
  }
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_top_content_container .no_of_application {
  border: 0.4rem solid #4cb35b;
  height: 100%;
  display: flex;
  flex-direction: column;
  align-items: center;
...
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_top_content_container .no_of_application h3 {
  font-size: 0.8rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_top_content_container .no_of_application h4 {
  font-size: 0.8rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_top_content_container .chart_container {
  height: 100%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_top_content_container .chart_container #application_Bar_chart {
  height: 100%;
}
@media (min-width: 821px) {
  .Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_bottom_content_container {
    height: 64%;
  }
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_bottom_content_container .treechart_holder {
  width: 100%;
  height: 100%;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_bottom_content_container .treechart_holder h4 {
  font-size: 0.8rem;
  margin: 1% 0 0 0;
  font-weight: 600;
}
.Mainbody_conatiner .Mainbody_content .project_register_content_container .dashboard_container .dashboard_content .dashboard_right_content_container .dashboard_right_bottom_content_container .treechart_holder #TreeChart {
  width: 100%;
  height: 100%;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container label.outcome_custom_width {
  width: 14.4%;
  display: flex;
  padding-right: 1%;
  align-items: center;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container label.outcome_custom_width button {
  background-color: transparent;
  border: none;
  margin-left: auto;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .outcome_minus {
  background-color: transparent;
  border: none;
}
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container {
  margin-top: 3%;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container h3.table_heading {
  font-size: 0.9rem;
  margin: 0 0 2% 0;
  font-family: Poppins_bold;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table th,
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table td {
  font-size: 0.75rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table thead tr {
  background-color: #39b0d2;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table thead th {
  border: 2px solid #d9d9d9;
  vertical-align: middle;
  color: #fff;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table thead th.borders {
  border-bottom: 1px solid #dee2e6;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody th {
  border: 2px solid #d9d9d9;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody tr td:nth-child(1) {
  padding-left: 2%;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody tr td:nth-child(1) input {
  background-color: transparent;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody td {
  font-family: Poppins_bold;
  vertical-align: middle;
  padding: 0.3rem;
  border: 2px solid #d9d9d9;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody td button img {
  width: 16px;
  aspect-ratio: 1/1;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody td p {
  margin: 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody td input {
  background-color: #d9d9d9;
  border-radius: 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .components_table_container table tbody td button {
  background-color: transparent;
  border: none;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan {
  width: 100%;
  height: auto;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan thead {
  font-family: Poppins_bold;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan thead tr th {
  background-color: #39b0d2;
  padding: 1.3rem 1rem;
  color: #fff;
  border: 2px solid #d9d9d9;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan tbody tr td {
  font-weight: 600;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan tbody tr td input {
  background-color: #f5f5f5;
  text-align: end;
  padding: 0.5rem;
  border: none;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan tbody tr td:nth-child(2) {
  text-align: center;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan tbody tr td:nth-child(2) input {
  background-color: #d9d9d9;
  text-align: end;
  padding: 0.5rem;
  border: none;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan tbody tr:last-child td {
  font-weight: 600;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .komponen_three_table_kewagan tbody tr:last-child td input {
  background-color: #d9d9d9;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan {
  width: 100px;
  height: auto;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan thead {
  font-family: Poppins_bold;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan thead tr th {
  padding: 0.9rem 1rem;
  color: #fff;
  font-weight: 400;
  border: none;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr td {
  font-weight: 600;
  padding: 0.6rem 1rem;
  border: none;
  position: relative;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr td input {
  background-color: #f5f5f5;
  text-align: end;
  padding: 0.5rem;
  border: none;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr td:first-child {
  text-align: left;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr td:nth-child(2) {
  text-align: center;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr td:nth-child(2) input {
  background-color: #d9d9d9;
  border-radius: 0rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr:last-child td {
  font-weight: 600;
  background-color: #39b0d2;
  position: relative;
  z-index: 1;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .projek_table_kewagan tbody tr:last-child td input {
  background-color: #d9d9d9;
  border-radius: 0rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan {
  width: 100%;
  height: auto;
  border: 2px solid #707070;
  border-bottom: none;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan thead {
  font-family: Poppins_bold;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan thead tr {
  background-color: transparent !important;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan thead tr th {
  padding: 0.8rem 1rem;
  color: #000;
  font-size: 0.75rem;
  border: none;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tfoot td {
  font-weight: 600;
  background-color: #39b0d2;
  position: relative;
  z-index: 1;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tfoot td:last-child {
  border-radius: 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tfoot td input {
  background-color: #d9d9d9;
  padding: 0.3rem;
  border-radius: 2.5rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tbody tr td,
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tfoot tr td {
  border: none;
  font-weight: 600;
  font-size: 0.75rem;
  padding: 10px;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tbody tr td input,
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tfoot tr td input {
  background-color: #fff;
  text-align: end;
  padding: 0.3rem;
  border-radius: 2.5rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tbody tr td:first-child,
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tfoot tr td:first-child {
  text-align: left;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tbody tr td:first-child::after,
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tfoot tr td:first-child::after {
  display: none;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tbody tr td:last-child input,
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_kewagan tfoot tr td:last-child input {
  background-color: #d9d9d9;
  text-align: end;
  padding: 0.3rem;
  border-radius: 0;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_sec_kewagan tbody tr td p {
  font-size: 0.75rem;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_sec_kewagan tbody tr td:first-child::after {
  display: block;
  border-radius: 0;
  border: none;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .perkara_table_sec_kewagan tbody tr:first-child td::after {
  display: none;
}
...
.Mainbody_conatiner .Mainbody_content .Mainbody_content_nav_header h4.project_list {
  font-size: 0.8rem;
  text-shadow: none;
  color: #6C757D;
  padding-left: 2%;
...
.Mainbody_conatiner .VAE-page .VAE-topic {
  font-size: 1.2rem;
  font-style: italic;
  font-weight: 600;
  padding-bottom: 1%;
...
.Mainbody_conatiner .VAE-page .VAE-topic span {
  font-style: normal;
}
.Mainbody_conatiner .VAE-page .acquistion-topic {
  border-bottom: 1px solid #d6d6d6;
  margin-bottom: 2%;
}
.Mainbody_conatiner .VAE-page .acquistion-topic .acquistion-topic-p {
  font-size: 0.9rem;
  margin: 0;
}
.Mainbody_conatiner .VAE-page .acquistion-topic .acquistion-topic-small-p {
  font-size: 0.6rem;
}
.Mainbody_conatiner .VAE-page label {
  font-size: 0.8rem;
  font-weight: 600;
}
...
.Mainbody_conatiner .VAE-page .calculator-container {
  padding: 2% 0;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-topic {
  font-size: 0.9rem;
  font-weight: 600;
  margin-bottom: 2%;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table {
  width: 70%;
  margin-left: 4%;
  font-size: 0.9rem;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table thead tr .level {
  width: 80px;
  padding-top: 0;
  padding-bottom: 0;
  vertical-align: middle;
...
.Mainbody_conatiner .VAE-page .calculator-container .calc-table thead tr th {
  border: 1px solid black;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table thead tr .image-th {
  width: 40px;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tbody tr {
  border: 1px solid black;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tbody tr .attribute-td {
  display: flex;
  align-items: center;
  justify-content: space-between;
  border: 0;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tbody tr .attribute-td p {
  margin-bottom: 0;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tbody tr .image-td {
  padding: 10px;
  text-align: center;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tbody tr td {
  padding: 10px;
  border: 1px solid black;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tbody tr td button {
  width: 95%;
  height: 40px;
  border: 1px solid black;
  border-radius: 5px;
...
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tfoot button {
  width: 95%;
  height: 40px;
  border: 1px solid black;
  border-radius: 5px;
...
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tfoot .score-td p {
  font-size: 1.2rem;
  font-weight: 600;
  display: flex;
  align-items: center;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tfoot .score-td p img {
  margin-left: 10px;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tfoot .score-td button {
  width: -webkit-max-content;
  width: -moz-max-content;
  width: max-content;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tfoot td {
  border: 1px solid black;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tfoot .show-table {
  width: 200px;
  background-color: #ced4da;
  padding: 5px;
  border-radius: 5px;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tfoot .show-table table {
  background-color: white;
  margin: 0;
}
.Mainbody_conatiner .VAE-page .calculator-container .calc-table tfoot .show-table table td {
  font-size: 0.7rem;
  padding: 0;
}
...
.Mainbody_conatiner .VAE-page .daya-accordion .card-body {
  display: flex;
  align-items: center;
  justify-content: center;
  padding: 5px 0 5px;
...
.Mainbody_conatiner .VAE-page .daya-accordion table {
  width: 70%;
  margin-bottom: 0;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr {
  border: 1px solid black;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr td {
  text-align: left;
  font-size: 0.8rem;
  padding: 0;
  border: 1px solid black;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr td p {
  padding-top: 7%;
  font-style: italic;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr td ol {
  padding: 0;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr td ol li {
  list-style-position: inside;
  list-style-type: upper-roman;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-1 {
  width: 20%;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-2 {
  width: 5%;
  text-align: center;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-3 {
  width: 20%;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-4 {
  width: 5%;
  text-align: center;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-5 {
  width: 25%;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-6,
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-7 {
  width: 4%;
  font-size: 1.1rem;
  font-weight: 700;
  vertical-align: middle;
...
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-bg-yellow {
  background-color: #ffff99;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-bg-green {
  background-color: #c4d79b;
}
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-bg-red {
  background-color: #ff7575;
}
.Mainbody_conatiner .VAE-page .daya-accordion .nota-container {
  width: 75%;
  background-color: #ffff99;
  font-size: 0.8rem;
  margin-top: 3%;
...
.Mainbody_conatiner .VAE-page .daya-accordion .nota-container .nota-topic {
  margin: 0;
  text-decoration: underline;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt {
  width: 70%;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt table tbody .vae_text {
  color: #000;
  font-size: 1.2rem;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt table tbody .red {
  background-color: #ff7575;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt table tbody .green {
  background-color: #c4d79b;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt table tbody td {
  border: 1px solid #ced4da;
  width: 50%;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt table tbody td img {
  text-align: center;
  width: 6%;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt table tbody td .pop_content {
  left: 40%;
  background-color: #cdcccc;
  width: 16%;
  text-align: center;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt table tbody td .pop_content p {
  font-size: 0.8rem;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt .vae_p {
  font-size: 0.85rem;
  margin-top: 0.8%;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt .vae_table_two tbody tr {
  border: 0;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt .vae_table_two tbody td {
  width: 52%;
  padding: 0.5rem 0rem;
  border: 1px solid #ced4da;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt .vae_table_two tbody td .pop_btn {
  width: 5%;
  cursor: pointer;
}
.Mainbody_conatiner .VAE-page .vae_acc_6_conetnt h4 {
  margin: 2% 0%;
  font-size: 1.1rem;
  color: #000;
  font-weight: 600;
...
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_form_header {
  display: flex;
  margin: 0% 3%;
  width: 90%;
  gap: 1.5rem;
...
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select {
  width: 80%;
  padding: 0% 8%;
  margin-top: 2%;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container {
  margin-bottom: 2.5%;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container label {
  margin: 0;
  font-size: 0.88rem;
  color: #646c9a;
  font-weight: 600;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container label p {
  margin: 0 0.6rem 0 0;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container label button {
  background-color: transparent;
  border: none;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container label button img {
  width: 80%;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container input {
  width: 0;
  height: 0;
  visibility: hidden;
  position: absolute;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container .pop_content {
  top: 12%;
  left: 11%;
  width: 40%;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container .pop_content p {
  margin: 0;
  background-color: #d9d9d9;
  color: #585e6e;
  padding: 9% 0.6rem;
...
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container .upload_img h5 {
  font-size: 0.65rem;
  margin: 1% 0 1% 0;
  font-family: Poppins_bold;
}
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_file_select .img_input_container .upload_img p {
  font-size: 0.65rem;
  margin-bottom: 0.2rem;
}
...
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .inputs .form-control {
  border-radius: 0;
...
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-body .dokumen_body_table table {
  border-radius: 4px;
  overflow: hidden;
}
...
.dokumen_modal_content .modal .modal-dialog .modal-content .modal-footer .modal_btn {
  margin-top: 12%;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box {
  width: 100%;
  padding: 3% 0% 1% 2%;
  border-bottom: 1px solid #ced4da;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_parent {
  display: flex;
  justify-content: space-between;
  width: 100%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .select_box_header {
  width: 88%;
  margin-left: 1.7%;
  font-size: 1.01rem;
  font-weight: 600;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs {
  display: flex;
  width: 100%;
  margin-top: 1%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs .visibility_hidden {
  visibility: hidden;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs .nageri_form_group {
  width: 70%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs .nageri_form_group .nageri_color {
  color: red;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs .nageri_form_group label {
  font-size: 0.8rem;
  color: #000;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs .nageri_form_group .form-control {
  height: auto;
  padding: 0.65rem 1rem;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs .nageri_form_group select {
  width: 100%;
  margin-left: 2%;
  font-size: 0.84rem;
  color: #000;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs .nageri_form_group select:focus {
  box-shadow: none;
  outline: none;
  border: 1px solid #dcdbdb;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_inputs .nageri_form_group select option:hover {
  background-color: red !important;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_select_box .nageri_select_footer {
  color: #000;
  margin-top: 2%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content {
  width: 100%;
  padding: 1.2% 2% 2% 2%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map_inputs {
  display: flex;
  gap: 1rem;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map_inputs .nageri_lat,
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map_inputs .nageri_long {
  width: 28%;
  align-items: center;
  display: flex;
  justify-content: space-between;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map_inputs .nageri_lat label,
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map_inputs .nageri_long label {
  margin: 0px;
  font-size: 0.8rem;
  font-weight: 600;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map_inputs .nageri_lat .form-control,
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map_inputs .nageri_long .form-control {
  width: 38%;
  font-size: 0.8rem;
  text-align: right;
  padding-right: 0px !important;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map {
  width: 100%;
  margin-top: 2%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_map_content .nageri_map iframe {
  width: 100%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs p {
  font-size: 0.8rem;
  padding-left: 3.9%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .nageri_files {
  display: flex;
  align-items: center;
  width: 80%;
  margin: auto;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container {
  width: 45%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container label {
  margin: 0;
  font-size: 0.88rem;
  color: #646c9a;
  font-weight: 600;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container label p {
  margin: 0 0.6rem 0 0;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container label button {
  background-color: transparent;
  border: none;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container label button img {
  width: 80%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container input {
  width: 0;
  height: 0;
  visibility: hidden;
  position: absolute;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container .pop_content {
  top: 15.5%;
  left: 18%;
  width: 38%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container .pop_content p {
  margin: 0;
  background-color: #d9d9d9;
  color: #585e6e;
  padding: 5% 0.6rem;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container .upload_img {
  padding: 2% 0;
  text-align: center;
  color: #6c757c;
  border: 1px dashed #8c979d;
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container .upload_img img {
  width: 8%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container .upload_img h5 {
  font-size: 0.65rem;
  margin: 1% 0 1% 0;
  font-family: Poppins_bold;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .img_input_container .upload_img p {
  font-size: 0.65rem;
  margin-bottom: 0.2rem;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .nageri_textarea {
  width: 45%;
  margin: 0px;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .nageri_textarea label {
  margin-bottom: 0.1rem;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .nageri_textarea textarea:focus {
  outline: none;
  box-shadow: none;
  border: 1px solid #ced4da;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .button_nageri {
  width: 87%;
  margin-top: 0.5%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_file_inputs .button_nageri button {
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables {
  width: 95%;
  margin: auto;
  margin-left: 3%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table {
  margin-top: 0.5%;
  border-radius: 4px;
  overflow: hidden;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table .nageri_roll {
  width: 150px;
  text-align: center;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table th {
  background-color: #39afd1;
  border: none;
  color: #fff;
  font-weight: 500;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table .border_right {
  padding-right: 0px;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table td {
  border: none;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table td .nageri_table_img {
  width: 530px;
  border: 1px dashed #ced4da;
  padding: 0.6rem;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table td .nageri_table_img p {
  margin: 0px;
  font-size: 0.9rem;
  color: #a7b0b5;
  padding-left: 7%;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table td .nageri_table_text {
  width: 400px;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table td .nageri_table_text p {
  font-size: 0.7rem;
  margin: 0px;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table td .nageri_table_btn {
...
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table td .nageri_table_btn .nageri_union {
  background-color: #fff;
  border-radius: 50%;
  width: 20px;
}
.nageri_container .nageri_right_content .nageri_form_content .nageri_tables table td .nageri_table_btn .nageri_union img {
  width: 40%;
}
.nageri_container .nageri_right_content .nageri_footer {
  display: flex;
  margin-top: 2%;
  justify-content: center;
  gap: 1.6rem;
}
.nageri_container .nageri_right_content .nageri_footer button {
  border: none;
  border-radius: 3px;
...
.nageri_container .nageri_right_content .nageri_footer .nageri_green {
  background-color: #0abb87 !important;
}

.dokumen_right_content .dokumen_form {
  border: 1px solid #ced4da;
  border-radius: 3px;
  width: 98%;
  margin: auto;
...
.dokumen_right_content .dokumen_form .dokum_form_header {
  border-bottom: 1px solid #ced4da;
  padding: 0.4% 1% 0.7%;
  color: #464457;
  font-weight: 600;
}
.dokumen_right_content .dokumen_form .dokumen_tables {
  margin-top: 2%;
}
.dokumen_right_content .dokumen_form .dokumen_tables table {
  border-radius: 4px;
  overflow: hidden;
}
.dokumen_right_content .dokumen_form .dokumen_tables table th {
  background-color: #39afd1;
  border: none;
  font-size: 0.96rem;
  padding-top: 0.2rem;
...
.dokumen_right_content .dokumen_form .dokumen_tables table .th_2 {
  width: 400px;
  text-align: left;
  padding-left: 4%;
}
.dokumen_right_content .dokumen_form .dokumen_tables table .th_3 {
  width: 200px;
  text-align: center;
}
.dokumen_right_content .dokumen_form .dokumen_tables table .th_4 {
  width: 150px;
}
.dokumen_right_content .dokumen_form .dokumen_tables table .th_5 {
  text-align: center;
}
.dokumen_right_content .dokumen_form .dokumen_tables table td {
  border: none;
  font-size: 0.9rem;
  color: #000;
  font-weight: 600;
}
.dokumen_right_content .dokumen_form .dokumen_tables table td button {
...
.dokumen_right_content .dokumen_form .dokumen_tables table td .Delete {
  cursor: pointer;
}
.dokumen_right_content .dokumen_form .dokumen_tables table td .dokumen_padam {
  display: flex;
  gap: 0.4rem;
  padding: 0.5rem 0.75rem;
  background-color: #fa5c7c;
}
.dokumen_right_content .dokumen_form .dokumen_tables table td .dokumen_padam img {
  width: 22%;
}
.dokumen_right_content .dokumen_form .dokumen_tables table .Dokumen_text p {
  font-size: 0.7rem;
  margin: 0px;
}
.dokumen_right_content .dokumen_btns {
  display: flex;
  justify-content: center;
  gap: 1rem;
  margin-top: 12%;
}
.dokumen_right_content .dokumen_btns button {
  border: none;
  background-color: #1a7df3;
  color: #fff;
  padding: 0.65rem 0.85rem;
  border-radius: 3px;
  font-size: 0.9rem;
}
.dokumen_right_content .dokumen_btns .green {
  background-color: #0abb87;
}

.perakuan_right_content form .perakuan_content {
  width: 98%;
  border: 1px solid #ced4da;
  border-radius: 4px;
  padding: 2.5% 2% 0% 2%;
}
.perakuan_right_content form .perakuan_content .perakuan_form_header {
  border-bottom: 1px solid #ced4da;
  padding: 0% 1% 1% 1%;
  color: #202020;
  font-weight: 600;
}
.perakuan_right_content form .perakuan_content .perakuan_tables {
  padding: 2% 2% 2%;
}
.perakuan_right_content form .perakuan_content .perakuan_tables table {
  border-radius: 4px;
  overflow: hidden;
}
.perakuan_right_content form .perakuan_content .perakuan_tables table th {
  border: none;
  color: #fff;
  font-weight: 500;
  background-color: #39afd1;
}
.perakuan_right_content form .perakuan_content .perakuan_tables table td {
  border: none;
  color: #000;
  font-size: 0.9rem;
  font-weight: 600;
}
.perakuan_right_content form .perakuan_content .form_group_perakuan {
  padding: 0% 2% 2%;
}
.perakuan_right_content form .perakuan_content .form_group_perakuan label {
  color: #000;
  font-size: 0.94rem;
  font-weight: 600;
}
.perakuan_right_content form .perakuan_content .form_group_perakuan .form-control {
  background-color: #dfdfdf;
}
.perakuan_right_content form .perakuan_btns {
  margin-top: 2%;
  display: flex;
  justify-content: center;
  gap: 0.6rem;
}
.perakuan_right_content form .perakuan_btns button {
  font-size: 0.9rem;
  width: 15.5%;
  border: none;
  color: #fff;
...
.perakuan_right_content form .perakuan_btns .blue {
  background-color: #5b63c3;
}
.perakuan_right_content form .perakuan_btns .green {
  background-color: #0abb87;
}
...
.ringkasan_container .input_fill_content {
  padding: 10px 0;
}
.ringkasan_container .input_fill_content p {
  font-size: 12px;
  color: #212529;
  font-weight: 500;
}
.ringkasan_container .input_fill_content ol {
  padding-left: 12px;
}
.ringkasan_container .input_fill_content ol li {
  font-size: 12px;
  color: #212529;
}
...
.input_fill_content button.green {
  background-color: #4da84b;
  color: #fff;
  font-size: 0.85rem;
  border-radius: 0.2rem;
...
.input_fill_content p {
  font-size: 0.8rem;
  font-weight: 600;
  color: #666666;
}
.input_fill_content label {
  margin: 0;
  width: 19%;
  font-size: 0.75rem;
  font-family: Poppins_bold;
...
.input_fill_content label sup {
  font-size: 0.9rem;
  color: red;
}
.input_fill_content label span {
  font-family: Poppins_Regular;
  color: #666666;
  font-weight: 400;
  font-size: 0.65rem;
}
.input_fill_content .r_container {
  width: 11%;
  color: #666666;
  font-weight: 600;
  font-family: Poppins_Regular;
}
.input_fill_content .r_container .checkmark {
  top: 2px;
}
.input_fill_content .input_form_group {
  width: 80.7%;
}
.input_fill_content .info {
  top: 10%;
  left: 8%;
}
.input_fill_content .info button {
  padding: 0;
  background-color: transparent;
  border: none;
  border-radius: 50%;
}
.input_fill_content .pop_content {
  border-radius: 0.3rem;
  font-size: 0.6rem;
  background-color: #e9e9e9;
  padding: 1.2rem 2%;
...
.input_fill_content table.skop td,
.input_fill_content table.skop tr {
  padding: 0;
}
.input_fill_content table.skop thead th {
  font-size: 0.8rem;
  font-family: Poppins_bold;
  padding: 0.5rem;
  border: none;
}
.input_fill_content table.skop tbody tr:nth-child(odd) {
  background-color: #f6f7fb;
}
.input_fill_content table.skop tbody tr td {
  padding: 0.4rem;
}
.input_fill_content .skop_card_content {
  border-color: #ced4da;
}
.input_fill_content .skop_card_content button {
  background-color: transparent;
  border: none;
  padding: 0;
}
.input_fill_content .skop_card_content .skop_content:nth-child(odd) {
  background-color: #f6f7fb;
}
.input_fill_content .skop_card_content .skop_content {
  margin: 0;
}
.input_fill_content .skop_card_content .skop_content input,
.input_fill_content .skop_card_content .skop_content select {
  border: 1px solid #ced4da;
}
.input_fill_content .skop_card_content .skop_footer {
  background-color: #39aed1;
}
.input_fill_content .skop_card_content .skop_footer p {
  font-size: 0.8rem;
  font-weight: 400;
  color: #fff;
}
.input_fill_content .skop_card_content .skop_footer input {
  border: none;
}

.komponen_three_table {
  width: 100%;
  height: auto;
}
.komponen_three_table thead tr th {
  background-color: #39b0d2;
  padding: 1rem;
  color: #fff;
  font-weight: 400;
...
.komponen_three_table tbody tr td {
  padding: 0.5rem 0.8rem;
  border: 2px solid #d9d9d9;
  position: relative;
  z-index: 1;
...
.komponen_three_table tbody tr td:nth-child(2) {
  text-align: center;
}
.komponen_three_table tbody tr td:nth-child(2)::after {
  content: "";
  display: block;
  width: 95%;
  height: 70%;
...
.komponen_three_table tbody tr:last-child td {
  position: relative;
  z-index: 1;
}
.komponen_three_table tbody tr:last-child td::after {
  content: "";
  display: block;
  width: 95%;
  height: 70%;
...
.komponen_three_table tbody tr:last-child td:first-child {
  text-align: right;
}
.komponen_three_table tbody tr:last-child td:first-child::after {
  display: none;
}
...
.projek_table tbody tr td:first-child {
  text-align: left;
}
.projek_table tbody tr td:nth-child(2) {
  text-align: center;
}
.projek_table tbody tr td:nth-child(2)::after {
  content: "";
  display: block;
  width: 95%;
  height: 70%;
...
.projek_table tbody tr:last-child td {
  background-color: #39b0d2;
  position: relative;
  z-index: 1;
}
.projek_table tbody tr:last-child td::after {
  content: "";
  display: block;
  width: 95%;
  height: 70%;
...
.projek_table tbody tr:last-child td:first-child {
  color: #fff;
  text-align: right;
}
.projek_table tbody tr:last-child td:first-child::after {
  display: none;
}
.projek_table tbody tr:last-child td:nth-child(2)::after {
  border-radius: 0;
}
...
.perkara_table thead tr th {
  padding: 10px 15px;
  font-size: 10px;
  border-bottom: 1px solid #cdcdcd;
}
.perkara_table tbody tr td {
  font-size: 10px;
  padding: 10px;
  position: relative;
  z-index: 1;
...
.perkara_table tbody tr td::after {
  content: "";
  display: block;
  width: 95%;
  height: 70%;
...
.perkara_table tbody tr td:first-child {
  text-align: left;
}
.perkara_table tbody tr td:first-child::after {
  display: none;
}
.perkara_table tbody tr td:last-child::after {
  content: "";
  display: block;
  width: 95%;
  height: 70%;
...
.perkara_table tbody tr:last-child td {
  background-color: #39b0d2;
  position: relative;
  z-index: 1;
  border: 2px solid #39b0d2;
}
.perkara_table tbody tr:last-child td::after {
  content: "";
  display: block;
  width: 95%;
  height: 70%;
...
.perkara_table tbody tr:last-child td:first-child {
  color: #fff;
  text-align: right;
}
.perkara_table tbody tr:last-child td:first-child::after {
  display: none;
}
.perkara_table tbody tr:last-child td:last-child::after {
  border-radius: 0;
}

.perkara_table_sec tbody tr td:first-child {
  text-align: center;
}
.perkara_table_sec tbody tr td:first-child::after {
  display: block;
  border-radius: 0;
  width: 50%;
}
.perkara_table_sec tbody tr:first-child td:first-child {
  text-align: left;
}
.perkara_table_sec tbody tr:first-child td::after {
  display: none;
}

.komponen_three_table_sec thead tr th {
  padding: 10px;
  text-align: center;
}
.komponen_three_table_sec thead tr:first-child th:first-child {
  text-align: left;
}
.komponen_three_table_sec tbody tr td:first-child {
  text-align: left;
}

.komponen_tab_rem tbody tr:nth-child(4) td, .komponen_tab_rem tbody tr:nth-child(5) td, .komponen_tab_rem tbody tr:nth-child(6) td {
  padding-left: 30px;
}
...
.projek_cmn_table thead tr {
  border-radius: 5px;
  overflow: hidden;
}
.projek_cmn_table thead tr th {
  background-color: #39b0d2;
  font-weight: 400;
  color: #fff;
  font-size: 12px;
...
.projek_cmn_table tbody {
  border: 1px solid #dee1e6;
  border-radius: 5px;
}
.projek_cmn_table tbody tr td {
  font-size: 12px;
  padding: 10px;
  text-align: left;
}

.projek_cmn_table_center thead tr th {
  text-align: center;
}
.projek_cmn_table_center thead tr th:first-child {
  text-align: left;
}
.projek_cmn_table_center tbody tr td {
  text-align: center;
}
.projek_cmn_table_center tbody tr td:first-child {
  text-align: left;
}
...
/* 2023 April 4 by Nabilah starts */
