...
.add_rmk_data_modal_container #add_rmk_data_modal .add_rmk_data_modal_dialog .add_rmk_data_modal_content .add_rmk_data_modal_body table {
  font-size: 0.8rem;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container select[disabled] {
    -webkit-appearance: none;
    -moz-appearance: none;
...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .brief_project_container .brief_project_content_container .input_container .input_fill_content button.green {
  background-color: #0ACF97; /* 2023 March 20 by Nabilah*/
  color: #fff;
  font-size: 0.85rem;
  border-radius: 0.2rem;
  border: none;
...
.Mainbody_conatiner .Mainbody_content .userlist_container .userlist_content .user_register_tab_container .user_register_tab_content_container .user_register_tab_content .user_register_form_content form select {
  ...
  background-repeat: no-repeat;
  background-position: right 0.2rem top 40%;
  background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='32' height='32'><path fill='none' d='M0 0h24v24H0z'/><path d='M12 16l-6-6h12z' fill='rgba(126,126,126,1)'/></svg>");
}
.Mainbody_conatiner .Mainbody_content .userlist_container .userlist_content .user_register_tab_container .user_register_tab_content_container .user_register_tab_content .user_register_form_content form select[disabled] {
    -webkit-appearance: none;
    -moz-appearance: none;
    background-image: none;
}
...
.rmk_flow_Chart .rmk_flow_Chart_container .rmk_flow_Chart_content_negeri {
  width: 22%;
}
