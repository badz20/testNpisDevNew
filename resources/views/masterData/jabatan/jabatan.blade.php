...
@include('masterData.jabatan.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/Jabatan" class="active text-secondary"> Jabatan</a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header row">
                ...
                <button
                    ...
                    data-toggle="modal"
                    style="height: 39px; width:155px; display: flex; align-items: center;"
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x"></i> Data Jabatan
                  </button>
            ...
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                ...
                <div class="form-group">
                    ...
                    <select  class="form-control form-select" name="kementerian" id="kementerian">  
                ...
                <div class="form-group">
                    <label for="nama">Kod Jabatan</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.jabatan.script')
