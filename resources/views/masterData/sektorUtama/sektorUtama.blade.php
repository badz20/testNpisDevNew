...
@include('masterData.sektorUtama.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/SektorUtama" class="active text-secondary"> Sektor Utama</a></li>
              </ul>
            </div>
          </div>
              ...
              <div class="userlist_content_header row">
                ...
                <div class="userlist_content_header_right d-flex col-lg-5 col-md-5 col-12">
                  <button
                    ...
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x"></i> Data Sektor Utama
                  </button>
          ...
          >
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="sektorUtamaForm"   role="form">
                <input type="hidden"  id="id" name="id">
                <div class="form-group">
                    <label for="nama">Bahagian EPU JPM</label>
                    <select  class="form-control form-select" style="font-size: 0.8rem;" onchange="changeKategori()" name="bahagian" id="bahagian">                                              
                    <option value=""> --Pilih--</option>
                    </select>                  
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Sektor Utama</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
                ...
                <div class="form-group">
                    <label for="nama">Kod Sektor Utama</label>                    
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.sektorUtama.script')
