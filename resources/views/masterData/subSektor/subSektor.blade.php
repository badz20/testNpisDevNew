...
@include('masterData.subSektor.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              ...
              <li>
                ...
                <li><a href="/SubSektor" class="active text-secondary"> Sub Sektor</a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header row">
                ...
                <button
                    ...
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x"></i> Data Sub Sektor
                  </button>
          ...
          >
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="SubSektorForm"   role="form">
                <input type="hidden"  id="id" name="id">
                <div class="form-group">
                    <label for="nama">Bahagian</label>
                    <input
                      type="text"
                      class="form-control"
                      id="bahagian"
                  ...
                  <div class="form-group">
                    ...
                    <input
                      ...
                      readonly
                    />
                    <span class="error" id="error_sektorUtama"></span>
                  </div>

                <div class="form-group">
                    <label for="nama">Sektor</label>
                    
                    <select  class="form-control form-select" onchange="changeSektor()" style="font-size: 0.8rem;" name="sektor" id="sektor">
                    <option value=""> --Pilih--</option>                        
                    </select>
                    <span class="error" id="error_sektor"></span>
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Sub Sektor</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
                ...
                <div class="form-group">
                    <label for="nama">Kod Sub Sektor</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
                ...
                <div class="add_selenggara_data_modal_footer text-center">
                  ...
                  <input type="submit" class="btn btn-success" id="submit" value="Simpan" style="background-color: #5a63c2!important; font-size: 0.8rem;">
                </div>
                </form>
              </div>
            </div>
    ...
    @include('masterData.subSektor.script')
