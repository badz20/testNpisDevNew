...
@include('masterData.sektor.style')
        ...
        <div class="Mainbody_content">
          <div class="Mainbody_content_nav_header project_register d-flex">
            ...
            <li>
              ...
              <li><a href="/Sektor" class="active text-secondary"> Sektor</a></li>
            </ul>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header row">
                ...
                <button
                    ...
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x"></i> Data Sektor
                  </button>
            ...
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                ...
                <div class="form-group">
                    ...
                    <select  class="form-control form-select" onchange="changeSektorUtama()" name="sektorUtama" id="sektorUtama">
                ...
                <div class="form-group">
                    <label for="nama">Kod Sektor</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.sektor.script')
