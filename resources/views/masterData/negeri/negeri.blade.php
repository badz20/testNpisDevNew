...
@include('masterData.negeri.style')
        ...
        <div class="Mainbody_content">
          <div class="Mainbody_content_nav_header project_register d-flex">
            ...
            <ul class="path_nav">
              ...
              <li><a href="/Negeri" class="active text-secondary"> Negeri</a></li>
            </ul>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header">
                ...
                <button
                    ...
                    data-toggle="modal"
                    style="height: 39px; width:150px; display: flex; align-items: center;"
                    >
            ...
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                ...
                <input type="hidden"  id="id" name="id">
                  ...
                  <div class="form-group">
                    <label for="nama">Kod Negeri</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.negeri.script')
