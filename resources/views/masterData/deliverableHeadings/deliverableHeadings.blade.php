...
@include('masterData.deliverableHeadings.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/DeliverableHeadings" class="active text-secondary"> Deliverable Headings</a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              >
                <div class="d-flex align-items-center">
                  ...
                  <h5> Data Deliverable Heading</h5>
                </div>
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="DeliverableHeadingForm"   role="form">
                <input type="hidden"  id="id" name="id">
                <div class="form-group">
                    <label for="nama">Nama Heading</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
    ...
    @include('masterData.deliverableHeadings.script')
