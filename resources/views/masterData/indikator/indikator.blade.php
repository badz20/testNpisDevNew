...
@include('masterData.indikator.style')
        ...
        <div class="Mainbody_content">
          <div class="Mainbody_content_nav_header d-flex">
            ...
            <li>
              ...
              <li><a href="#" class="active"> Indikator</a></li>
            </ul>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header">
                ...
                <div class="icon_yellow_bg">
                    <i class="mdi mdi-database-outline icon_portal mx-1"></i>
                  </div>
                ...
                <button
                   ...
                   style="height: 60px; display: flex; align-items: center;"
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x pl-2" style="margin: 0.25rem;"></i>Tambah Data Indikator
                  </button>
                    ...
                    <div class="userlist_tab_contents_holder">
                        <div id="agensi_card" class="card-body p-3">
                            <table id="master_data" width="100%" class="display p-3 userlist_tab_content_table table">
                                <thead>
                                    <tr>
                                    <th class="float-left">Nama Indikator</th>                           
                                    <th>Kod Indikator</th> 
          ...
          >
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="IndikatorForm"   role="form">
                <input type="hidden"  id="id" name="id">
                <input type="hidden"  id="sdgid" name="sdgid">
                ...
                <div class="form-group">
                    ...
                    <select  class="form-control form-select" onchange="changeSasaran()" name="sasaran" id="sasaran"> 
                ...
                <div class="form-group">
                    <label for="nama">Kod Indikator</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.indikator.script')
