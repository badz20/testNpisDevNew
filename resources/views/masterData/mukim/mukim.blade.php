...
@include('masterData.mukim.style')
        ...
        <div class="Mainbody_content">
          <div class="Mainbody_content_nav_header project_register d-flex">
            ...
            <ul class="path_nav">
              ...
              <li><a href="/Mukim" class="active text-secondary"> Mukim</a></li>
            </ul>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header row">
                ...
                <button
                    ...
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x"></i>Data Mukim
                  </button>
            ...
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                ...
                <div class="form-group">
                    ...
                    <select  class="form-control form-select" onchange="changeDaerah()" name="daerah" id="daerah" style="font-size: 0.9rem;">
                    <option value=""> --Pilih--</option>                        
                    </select>
                    
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Mukim</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
                ...
                <div class="form-group">
                    <label for="nama">Kod Mukim</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.mukim.script')
