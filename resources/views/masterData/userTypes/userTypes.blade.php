...
@include('masterData.userTypes.style')
        ...
        <div class="Mainbody_content">
          <div class="Mainbody_content_nav_header d-flex">
            ...
            <ul class="path_nav">
              ...
              <li><a href="/UserType" class="active"> User Types</a></li>
            </ul>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header">
                ...
                <!-- <button
                    ...
                    data-toggle="modal"
                    style="height: 39px; width:175px; display: flex; align-items: center;"
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x pl-2" style="margin: 0.25rem;"></i> Data User Types
                  </button> -->
                    ...
                    <div class="userlist_tab_contents_holder">
                        <div id="agensi_card" class="card-body p-3">
                            <table id="master_data" width="100%" class="display p-3 userlist_tab_content_table table">
                                <thead>
                                    <tr>
                                    <th class="float-left">Nama User Type</th>
          ...
          >
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="userTypeForm"   role="form">
                <input type="hidden"  id="id" name="id">
                
                  <div class="form-group">
                    <label for="nama">Nama User Type</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
    ...
    @include('masterData.userTypes.script')
