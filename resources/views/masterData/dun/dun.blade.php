          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/Dun" class="active text-secondary"> Dun</a></li>
              </ul>
            </div>
          </div>
          ...
          >
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="dunForm"   role="form">
                <input type="hidden"  id="id" name="id">
                <div class="form-group">
                    <label for="nama">Negeri</label>
                    <input
                      type="text"
                      class="form-control"
                      id="negeri"
                ...
                <div class="form-group">
                    <label for="nama">Parlimen</label>
                    <select  class="form-control form-select" onchange="changeParlimen()" name="parlimen" id="parlimen"> 
                    <option value=""> --Pilih--</option>                       
                    </select>
                    
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Dun</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
