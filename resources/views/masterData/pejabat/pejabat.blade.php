...
@include('masterData.pejabat.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/PejabatProjek" class="active text-secondary">Pejabat Projek</a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header row">
                ...
                <button
                    ...
                    data-toggle="modal"
                    style="height: 39px; width:200px; display: flex; align-items: center;"
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x"></i> Data Pejabat Projek 
                  </button>
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="rmkForm">
                    ...
                    <div class="form-group">
                      <label for="nama_komponen">Nama Pejabat Projek</label>
                      <input
                        type="text"
    ...
    <section>
              ...
              <div class="modal-content add_selenggara_data_modal_content">
                ...
                <div class="modal-body add_selenggara_data_modal_body">
                  <form id="edit_rmkForm">
                      <input type="hidden" value="" id="update_id">
                      <div class="form-group">
                        <label for="edit_nama_komponen">Nama Pejabat Projek</label>
                        <input
                          type="text"
      ...
      @include('masterData.pejabat.script')
