...
@include('masterData.lookup_options.style')
        ...
        <div class="Mainbody_content">
          <div class="Mainbody_content_nav_header d-flex">
            ...
            <ul class="path_nav">
              ...
              <li><a href="#" class="active"> Options</a></li>
            </ul>
          </div>
              ...
              <div class="userlist_content_header">
                ...
                <button
                   ...
                   style="height: 60px; display: flex; align-items: center;"
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x pl-2" style="margin: 0.25rem;"></i>Tambah Data Options
                  </button>
                    ...
                    <div class="userlist_tab_contents_holder">
                        <div id="agensi_card" class="card-body p-3">
                            <table id="master_data" width="100%" class="display p-3 userlist_tab_content_table table">
                                <thead>
                                    <tr>
                                    <th class="float-left">Nama Option</th>
                                    <th>Kod Option</th> 
                                    <th>Key</th> 
                                    <th>Order Number</th> 
            ...
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                ...
                <div class="form-group">
                    ...
                    <select  class="form-control form-select" onchange="changeSkop()" name="key" id="key">                                              
                    <option value=""> --Pilih--</option>
                    </select>                  
                  </div>
                  <div class="form-group">
                    <label for="value">Nama Options</label>
                    <input
                      type="text"
                      class="form-control"
                      id="value"
                ...
                <div class="form-group">
                    <label for="code">Kod Options</label>                    
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.lookup_options.script')
