...
@include('masterData.deliverables.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/Deliverables" class="active text-secondary"> Deliverables</a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header row">
                ...
                <button
                    ...
                    data-toggle="modal"
                    style="height: 39px; width:130px; display: flex; align-items: center;">
                        ...
                        <div id="agensi_card" class="card-body p-3">
                            <table id="master_data" width="100%" class="display p-3 userlist_tab_content_table table table-responsive">
                                <thead>
                                    ...
                                    <th>Heading Deliverable</th>
                                    <th>Kod Deliverable</th>
                                    <th>Catatan</th> 
          ...
          >
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="deliverableForm"   role="form">
                <input type="hidden"  id="id" name="id">

                <div class="form-group">
                    <label for="nama">Heading</label>
                    <select  class="form-control form-select"  name="heading" id="heading"> 
                    <option value=""> --Pilih--</option>                       
                    </select>
                  </div>

                  <div class="form-group d-none" id="order_div">
                    <label for="nama">Order</label>
                    <select  class="form-control form-select"  name="order" id="order"> 
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Deliverable</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
                ...
                <div class="form-group">
                    <label for="nama">Kod Deliverable</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.deliverables.script')
