          ...
          <div class="Mainbody_content_nav_header project_register d-flex">
            ...
            <ul class="path_nav">
              <li>
                ...
                <li><a href="#" class="active text-secondary"> Selenggara Data</a></li>
            </ul>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header row">
                ...
                <button
                    ...
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x"></i>Data 
                  </button>
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="rmkForm">
                    ...
                    <div class="form-group">
                      <label for="tema">Tema / Pemangkin Dasar</label>
                      <input
                        type="text"
                        id="tema"
                        name="tema"
                    ...
                    <div class="form-group position-relative">
                      <label for="bidang">Bidang Keutamaan</label>
                      <input
                        type="text"
                        id="bidang"
                        name="bidang"
                    ...
                    <div class="form-group position-relative">
                      <label for="outcome">Outcome Nasional</label>
                      <input
                        type="text"
                        id="outcome"
                        name="outcome"
                    ...
                    <div class="add_masterdata_data_modal_footer d-flex justify-content-center">
                        ...
                        <button type="button" id="rmkStrategiBtn" class="btn btn-simpan m-2">Simpan</button>
                    </div>
                  </form>
              </div>
            </div>
              ...
              <div class="modal-content add_selenggara_data_modal_content">
                ...
                <div class="modal-body add_selenggara_data_modal_body">
                  <form id="edit_rmkForm">
                      <input type="hidden" value="" id="update_id">
                      <div class="form-group">
                        <label for="edit_tema">Tema / Pemangkin Dasar</label>
                        <input
                          type="text"
                          id="edit_tema"
                          name="edit_tema"
                      ...
                      <div class="form-group position-relative">
                        <label for="edit_bidang">Bidang Keutamaan</label>
                        <input
                          type="text"
                          id="edit_bidang"
                          name="edit_bidang"
                      ...
                      <div class="form-group position-relative">
                        <label for="edit_strategi">Strategi</label>
                        <input
                          type="text"
                          id="edit_strategi"
                          name="edit_strategi"
                      ...
                      <div class="add_masterdata_data_modal_footer d-flex justify-content-center">
                          <button type="button" class="btn btn-kembali m-2" data-dismiss="modal">Kembali</button>
                          <button type="button" id="edit_rmkStrategiBtn" class="btn btn-simpan m-2">Simpan</button>
                      </div>
                    </form>
                </div>
              </div>
