...
$(document).ready(function () {  
    ...
    const api_url = "{{ env('API_URL') }}"
        ...
        axios({
        method: 'get',
        url: api_url+"api/lookup/komponen/list",
        responseType: 'json'
        })
    ...
    function loadData(id) {    
      ...
      axios({
        method: 'get',
        url: "{{ env('API_URL') }}"+"api/lookup/komponen/list/" + id,
        responseType: 'json',
        headers: {
        ...
        .then(function (response) {
            ...
            var nama = response.data.data.nama_komponen            
            console.log(nama)     
            //$('#modal_body').html(id)
            $('#update_id').val(id)                
  ...
  function activateModul(id){
    Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios({
                method: 'POST',
                url: "{{ env('API_URL') }}"+"api/lookup/komponen_update_status",
                responseType: 'json',
                data:formData,   
                headers: {
                    "Content-Type": "application/json",
  ...
  $("#edit_komponen_Btn").click(function(){
   ...
   if(nama_komponen==''){
    ...
    var formData = new FormData();
            ...
            axios({
                method: 'POST',
                url: "{{ env('API_URL') }}"+'api/lookup/komponen_update',
                responseType: 'json',
                data:formData,   
                headers: {
                    "Content-Type": "application/json",
...
$("#addKomponenBtn").click(function(){
   ...
   if(nama_komponen==''){
    ...
    var formData = new FormData();
            ...
            axios({
                method: 'POST',
                url: "{{ env('API_URL') }}"+'api/lookup/komponen_add',
                responseType: 'json',
                data:formData,   
                headers: {
                    "Content-Type": "application/json",
