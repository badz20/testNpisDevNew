...
@include('masterData.bahagian.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="#" class="active text-secondary"> Bahagian</a></li>
              </ul>
            </div>
          </div>
                ...
                <div class="userlist_content_header_right d-flex">
                  <button
                    ...
                    >
                      ...
                      <i class="ri-add-circle-fill icon_white ri-2x"></i> Data Bahagian
                  </button>
          ...
          >
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                <form id="bahagianForm"   role="form">
                <input type="hidden"  id="id" name="id">
                <div class="form-group">
                    <label for="nama">Kementerian</label>
                    <input
                      type="text"
                      class="form-control"
                      id="kementerian"
                ...
                <div class="form-group">
                    ...
                    <select  class="form-control form-select" onchange="changeJabatan()" name="jabatan" id="jabatan"> 
                    <option value=""> --Pilih--</option>                       
                    </select>
                    
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Bahagian</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
                ...
                <div class="form-group">
                    <label for="nama">Kod Bahagian</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.bahagian.script')
