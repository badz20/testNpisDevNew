...
@include('masterData.subSkop.style')
        ...
        <div class="Mainbody_content">
          <div class="Mainbody_content_nav_header d-flex">
            ...
            <ul class="path_nav">
              ...
              <li><a href="#" class="active"> Sub Skop</a></li>
            </ul>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header">
                ...
                <button
                    ...
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x pl-2" style="margin: 0.25rem;"></i>Tambah Data Sub Skop
                  </button>
                    ...
                    <div class="userlist_tab_contents_holder">
                        <div id="agensi_card" class="card-body p-3">
                            <table id="master_data" width="100%" class="display p-3 userlist_tab_content_table table">
                                <thead>
                                    <tr>
                                    <th class="float-left">Nama Sub Skop</th>
                                    <th>Kod Sub Skop</th> 
                                    <th>Skop</th> 
            ...
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                ...
                <div class="form-group">
                    <label for="nama">Skop</label>
                    <select  class="form-control form-select" onchange="changeSkop()" name="skop" id="skop">                                              
                    <option value=""> --Pilih--</option>
                    </select>                  
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama Sub Skop</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
                ...
                <div class="form-group">
                    <label for="nama">Kod Sub Skop</label>                    
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.subSkop.script')
