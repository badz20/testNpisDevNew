...
@include('masterData.parliment.style')
          ...
          <div class="Mainbody_content_nav_header project_register row">
            ...
            <div class="col-md-7 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li><a href="/Parlimen" class="active text-secondary"> Parlimen</a></li>
              </ul>
            </div>
          </div>
            ...
            <div class="userlist_content">
              <div class="userlist_content_header row">
                ...
                <button
                    ...
                    data-toggle="modal"
                    style="height: 39px; width:160px; display: flex; align-items: center;"
                    >
                      <i class="ri-add-circle-fill icon_white ri-2x"></i> Data Parlimen
                  </button>
            ...
            <div class="modal-content add_selenggara_data_modal_content">
              ...
              <div class="modal-body add_selenggara_data_modal_body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="nama">Nama Parlimen</label>
                    <input
                      type="text"
                      class="form-control"
                      id="nama"
                ...
                <div class="form-group">
                    <label for="nama">Kod Parlimen</label>
                    <input
                      type="text"
                      class="form-control"
                      id="code"
    ...
    @include('masterData.parliment.script')
