          ...
          <div class="card cardPmakmal">
            <div class="card-body">
              ...
              <div class="topnav d-flex justify-content-around" id="myTopnav">
                <a href="#home" class="col-md-3 col-xs-12 mt-2" style="display: flex; align-items: center; justify-content: center; text-align: center;"><i class="ri-list-unordered ri-2x icon_dropdown mx-2"></i>Makmal Kajian Nilai (VA)</a>
                <a class="col-md-4 col-xs-12 active" href="#news" style="display: flex; align-items: center; justify-content: center; text-align: center;" ><i class="mdi mdi-wrench icon_white mx-2" style="font-size: 1.8em; transform: rotate(90deg);"></i>Makmal Kejuruteraan Nilai (VE)</a>
                      ...
                      <div class="brief_project_content">
                        <div style="height:5.5%; display: flex; align-items: center;">
                          ...
                          <div class="card-body">
                            ...
                            <h6 class="mb-3"><strong>Status Pelaporan Makmal</strong></h6>
                            <hr>
                              ...
                              <div class="d-flex justify-content-between">
                                ...
                                <div class="rmk_flow_Chart_content">
                                  <div class="box_content bend">
                                    <p class="yellow">Dalam Penjilidan</p>
                                  </div>
                                </div>
                              </div>
                                    ...
                                    <div class="col-md-6 col-xs-12 p-1 py-1">
                                        <div class="row align-items-center">
                                          ...
                                          <div class="col-md-6 col-xs-12 form-group">
                                              <input class="form-control" type="date" name="tarikh_kemuka" id="tarikh_kemuka">
                                ...
                                <div class="row m-1">
                                    ...
                                    <div class="col-md-6 col-xs-12 p-1 py-1">
                                        <div class="row align-items-center">
                                          ...
                                          <div class="col-md-6 col-xs-12 form-group">
                                              <input class="form-control" type="date" name="tarikh_terima" id="tarikh_terima">
                                ...
                                <div class="row m-1">
                                    ...
                                    <div class="col-md-6 col-xs-12 p-1 py-1">
                                        <div class="row align-items-center">
                                          ...
                                          <div class="col-md-6 col-xs-12 form-group">
                                              <input class="form-control" type="date" name="tarikh_edaran" id="tarikh_edaran">
                                              <p class="text-danger" id="tarikh_terima_error"></p>
                                          </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-content add_role_sucess_modal_content" style="width:88% !important;">
              <div class="modal-body add_role_sucess_modal_body">
                ...
                <div class="add_role_sucess_modal_body_Content" id="user_pop-up">
                  <h3 style="width:102% !important;">Maklumat berjaya di simpan<br></h3>
                ...
                <div class="modal-dialog modal-dialog-centered add_role_sucess_modal_dialog"
                    ...
                    <div class="modal-body add_role_sucess_modal_body">
                      <div class="add_role_sucess_modal_header text-end">
                        ...
                        <div class="add_role_sucess_modal_body_Content" id="user_pop-up">
                        <h5 style="text-align: center;">Proses penjilidan bagi Makmal Kejuruteraan Nilai (VE) telah selesai</h5>
                        <div class="text-center">
...
@include('valueManagement.penjilidan_ve_list.script')