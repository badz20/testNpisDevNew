    ...
    $(".vmKalendar_btn_grn").click(function(){
     ...
     document.addEventListener('DOMContentLoaded', function() {
        ...
        if(last_part=='VR'){
            ...
            document.getElementById("text_link").innerHTML ="Makmal Semakan Nilai (VR)";
            document.getElementById("top_link").innerHTML ="Makmal Semakan Nilai (VR)";
            document.getElementById("top_head_text").innerHTML ="Makmal Semakan Nilai (VR)";
            document.getElementById("pop_header").innerHTML ="Makmal Semakan Nilai (VR)";
        }else{
            $("#maklumat_pelakasanaan_makmal").attr("href", "/maklumat_pelakasanaan_makmal/"+{{$kod_projek}}+"/"+last_part+"")
            document.getElementById("text_link").innerHTML ="Makmal Kejuruteraan Nilai (VE)";
            document.getElementById("top_link").innerHTML ="Makmal Kejuruteraan Nilai (VE)";
            document.getElementById("top_head_text").innerHTML ="Makmal Kejuruteraan Nilai (VE)";
            document.getElementById("pop_header").innerHTML ="Makmal Kejuruteraan Nilai (VE)";
        }

        let user_type = {{$user_type}};
        if(user_type==4 && last_part=='VE')
        {
        ...
        .then(function (response) { 
            ...
            if({{$user_type}}==4)
            {
                if(status_perlaksanaan==31 || status_perlaksanaan==33 || status_perlaksanaan==36)
                {
                    $("#add_btn_div").removeClass("d-none");
                    $("#simpanBtn").removeClass("d-none");
                }
...
$("#kategori").change(function(){
    ...
    const api_token = "Bearer "+ window.localStorage.getItem('token');        
        ...
        axios({
            method: 'get',
            url: "{{ env('API_URL') }}"+"api/project/get_kalenderData?id="+pp_id+"&kategori="+selectedOption+"&type="+type,
            responseType: 'json',            
        })
