...
.side_bar_Container .sidebar_list_container #accordionParent .accordian_content .accordian_single_list .accordian_collapse_list ul a {
  text-decoration: none;
  display: block;
  padding: 0.3rem 0;
  font-size: 0.86rem;
...
.vmadd_role_sucess_modal_container #exampleModal2 {
  background-color: rgba(0, 0, 0, 0.2);
}
.VM_footer {
  color: #595D6E;
...
@media (max-width: 820px) {
  .NPIS_Container, .NPIS_Container-sm {
    width: auto;
  }
...
.required:after {
  ...
  #bahagian_view, #jawatan_view, #gred_view, #jabatan_view {
    appearance: none;
  }
</style>