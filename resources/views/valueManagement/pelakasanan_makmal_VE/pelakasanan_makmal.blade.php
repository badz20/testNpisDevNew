@include('valueManagement.pelakasanan_makmal_VE.style')
        ...
        <x-form.spinner>
          ...
          <div class="Mainbody_content_nav_header project_register align-items-center row">
            <div class="col-md-3 col-xs-12" >
              <h5 id="kajian_head">Makmal Kejuruteraan Nilai (VE)</h5>
            </div>
            <div class="col-md-9 col-xs-12 path_nav_col">
              <ul class="path_nav row">
                ...
                <li style="display: flex; align-items: center;">
                  <a href="#" class="active"> Makmal Kejuruteraan Nilai (VE) </a>
                </li>
              </ul>
            </div>
          </div>
          <div class="card cardPmakmal">
            <div class="card-body">
              ...
              <div class="topnav mt-4" id="myTopnav">
                ...
                <a class="active col-md-4 col-xs-12" style="display: flex; align-items: center; justify-content: center; text-align: center;" href="#news"><i class="mdi mdi-wrench icon_white mx-2" style="font-size: 1.8em; transform: rotate(90deg);"></i>Makmal Kejuruteraan Nilai (VE)</a>
                    ...
                    <div class="brief_project_content">
                      <div>
                        <div style="display: flex; align-items: center;">
                          ...
                          <h6 class="m-3"><strong>Makmal Kejuruteraan Nilai (VE)</strong></h6>
                        </div>
                        <div class="row col-9" style="position: relative;left: 20px;top: 15px;">
                          <div class="col-md-3 col-xs-12">
                      ...
                      <div class="card-body" id="card-body-1" >
                        ...
                        <form id="mmpm">
                            ...
                            <div class="col-md-5 col-xs-12 p-0 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-xs-12 form-group">
                                  <input disabled class="form-control" type="text" name="tarikh_cadangan" id="tarikh_cadangan" style="font-size: 0.8rem !important;">
                          ...
                          <div class="row d-flex m-1 justify-content-between">
                            <div class="col-md-5 col-xs-12 p-0 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-xs-12 form-group">
                                  <input class="form-control" type="text" name="tarikh_pra_makmal_sebenar" id="tarikh_pra_makmal_sebenar" style="font-size: 0.8rem !important;">
                            ...
                            <div class="col-md-5 col-xs-12 p-0 py-1">
                              <div class="row">
                                ...
                                <div class="col-md-8 col-xs-12 form-group">
                                  <div class="upload_img col-12" id="upload_sjm">
                                    <div class="row col-12">
                                    <label class="h6 d-flex" for="surat_jemputan_mesyuarat">
                                      <img
                          ...
                          <div class="row mt-4">
                            ...
                            <div  class="col-md-8 col-xs-12 row " >
                              <div class="upload_img col-md-6 col-xs-12" id="upload_mini">
                                <div class="row col-12">
                                  <label class="h6 d-flex" for="minit_mesyuara">
                                    <img
                                    src="{{ asset('Vm_module/assets/images/upload_img.png') }}"
                                    class="d-block m-auto"
                                    alt=""
                          ...
                          <div class="nageri_footer">
                            <button class="vmsimpan mt-3 align-self-center" id="simpan_mmpm" style="font-size: 0.8rem !important;">Simpan</button>
                          </div>
                        </form>
                        ...
                        <div class="row m-1">
                            <div class="col-md-6 col-xs-12 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-xs-12 form-group">
                                  <input disabled class="form-control" type="text" name="cadangan_makmal" id="cadangan_makmal" style="font-size: 0.8rem !important;"> 
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6 col-xs-12 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-7 col-xs-12 form-group">
                                  <input class="form-control" type="text" name="negeri" id="negeri" style="font-size: 0.8rem !important;">
                          ...
                          <div class="row m-1">
                            <div class="col-md-6 col-xs-12 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-xs-12 form-group">
                                  <input class="form-control" type="text" name="makmal_sebenar" id="makmal_sebenar" style="font-size: 0.8rem !important;"> 
                            ...
                            <div class="col-md-6 col-xs-12 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-7 col-xs-12 form-group">
                                  <input disabled class="form-control" type="text" name="lawatan_tapak" id="lawatan_tapak" style="font-size: 0.8rem !important;">
                          ...
                          <div class="row m-1">
                            <div class="col-md-6 col-xs-12 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-xs-12 form-group">
                                  <input disabled class="form-control" type="text" id="year" name="year" style="font-size: 0.8rem !important;">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6 col-xs-12 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-7 col-xs-12 form-group">
                                  <input disabled class="form-control" type="text" name="mesyuarat_date" id="mesyuarat_date" style="font-size: 0.8rem !important;">
                            ...
                            <div class="col-md-6 col-xs-12 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-xs-12 form-group d-flex">
                                  <span class="input-group-text Table_perunding_header" id="basic-addon2" style="font-size: 0.8rem !important;">RM</span>
                                  <input type="text" class="form-control kos_selepas_makmal text-right". placeholder="0.00" value="" aria-label="Username" aria-describedby="basic-addon2" id="kos_sebelum_makmal" style="font-size: 0.8rem !important;">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6 col-xs-12 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-7 col-xs-12 form-group d-flex">
                                  <span class="input-group-text Table_perunding_header" id="basic-addon3" style="font-size: 0.8rem !important;">RM</span>
                                  <input type="text" class="form-control kos_selepas_makmal text-right" placeholder="0.00" value="" aria-label="Username" aria-describedby="basic-addon3" id="kos_pelakas_selepas_makmal" style="font-size: 0.8rem !important;">
                          ...
                          <div class="nageri_footer">
                            <button class="vmsimpan mt-3 align-self-center" id="submit_butiran" style="font-size: 0.8rem !important;">Simpan</button>
                        ...
                        <h6 class="mt-4 mb-3" id="ve_head"><strong>Maklumat Kejuruteraan Nilai (VE)</strong></h6><hr>
                        ...
                        <div class="rmk_flow_Chart flow-horizontal" id="flow-horizontal">
                          <div class="rmk_flow_Chart_container">
                            <div class="d-flex justify-content-between">
                              ...
                              <div class="rmk_flow_Chart_content">
                                <h5>PENYELARAS MAKMAL VE (BPK)</h5>
                              </div>
                              <div class="rmk_flow_Chart_content_grey">
                                <h5>KETUA FASILITATOR,PENGARAH BAHAGIAN, TIMBALAN KETUA PENGARAH JPS</h5>
                              </div>
                              <div class="rmk_flow_Chart_content">
                                <h5>BAHAGIAN</h5>
                              </div>
                            ...
                            <div class="d-flex justify-content-between">
                              ...
                              <div class="rmk_flow_Chart_content">
                                <div class="box_content">
                                  <p id="tanda_draft_status">Tandatangan Laporan</p>
                                </div>
                              </div>
                              <div class="rmk_flow_Chart_content">
                                <div class="box_content bend">
                                  <p>Dalam Penjilidan</p>
                                </div>
                              </div>
                            </div>
                        ...
                        <form id="draft_laporan">
                          <div class="row m-1">
                            <div class="col-md-6 col-xs-12 p-0 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-6 col-xs-12 form-group d-flex">
                                  <span class="input-group-text Table_perunding_header" id="basic-addon1" style="font-size: 0.8rem !important;">RM</span>
                                  <input type="text" class="form-control kos_selepas_makmal text-right" placeholder="0.00" value="" aria-label="Username" style="font-size: 0.8rem !important;" aria-describedby="basic-addon1" id="kos_selepas_makmal">
                                </div>
                              </div>
                              <div class="row">
                            ...
                            <div class="table-responsive d-flex">
                              <table class="table table-bordered projek_cmn_table" id="oldobjektifTable">
                                <thead>
                                  <tr>
                                    <th class="text-center">Bil</th>
                                    <th class="text-center text-nowrap">Objektif Projek Sebelum Makmal</th>
                                  </tr>
                                </thead>
                              ...
                              <table class="table table-bordered projek_cmn_table" id="newobjektifTable">
                                <thead>
                                  <tr>
                                    <th class="text-center text-nowrap">Objektif Projek Selepas Makmal</th>
                          ...
                          <div class="table_scroll pt-4">
                            <div class="table-responsive  d-flex">
                                  <table class="table table-bordered projek_cmn_table_skop" id="projek_cmn_table_skop">
                                    <thead>
                                      <tr>
                                        <th class="text-center">Bil</th>
                                        <th class="text-center text-nowrap">Skop Projek Sebelum Makmal</th>
                                        <th class="text-center text-nowrap">Kos Projek Sebelum Makmal (RM)</th>
                                      </tr>
                                    </thead>
                                  ...
                                  <table class="table table-bordered projek_cmn_table_skop" id="newskopTable">
                                    <thead>
                                      <tr>
                                        <th class="text-center text-nowrap">Skop Projek Selepas Makmal</th>
                                        <th class="text-center text-nowrap">Kos Projek Selepas Makmal (RM)</th>
                                        <th class="text-center"><button class="vmplus_minus" id="addBtnSkop" type="button"><i class="ri-add-box-line ri-xl icon_white"></i></button></th>
                                      </tr>
                                    </thead>
                          ...
                          <h6 class="m-3" id="outcome_head"><strong>Perbandingan Outcome Sebelum dan Selepas Makmal</strong></h6>
                          <div class="table_scroll"  id="outcome_table">
                            <div class="table-responsive d-flex ml-4" style="width: 96%;">
                              ...
                              <table class="table table-bordered projek_cmn_table" id="newoutcometable">
                                <thead>
                                  <tr>
                                    ...
                                    <th class="text-center">Kuantiti/Bilangan</th>
                                    <th class="text-center">Unit</th>
                                    <th class="text-center"><button class="vmplus_minus" id="addBtnOutcome" type="button"><i class="ri-add-box-line ri-xl icon_white"></i></button></th>
                                  </tr>
                                </thead>
                          ...
                          <h6 class="m-3" id="output_head"><strong>Perbandingan Output Sebelum dan Selepas Makmal</strong></h6>
                          <div class="table_scroll" id="output_table">
                            <div class="table-responsive d-flex ml-4" style="width: 96%;">
                              ...
                              <table class="table table-bordered projek_cmn_table" id="newoutputtable">
                                <thead> 
                                  <tr>
                                    ...
                                    <th class="text-center">Kuantiti/Bilangan</th>
                                    <th class="text-center">Unit</th>
                                    <th class="text-center"><button class="vmplus_minus" id="addBtnOutput" type="button"><i class="ri-add-box-line ri-xl icon_white"></i></button></th>
                                  </tr>
                                </thead>
                          ...
                          <div id="ulasan_disabled">
                            <div class="mt-4 row ml-3">
                              <h6><strong>Ulasan Penyelaras</strong></h6>
                            </div>
                          ...
                          <div id="sejarah_ulasan">
                            <div class="mt-4 row ml-3">
                              <h6><strong>Sejarah Ulasan</strong></h6>
                            </div>
                            <div class="table_scroll pt-4 col-12">
                              <div class="table-responsive">
                                <table class="table table-bordered projek_cmn_table">
                          ...
                          <div id="penyeleras">
                                <div class="mt-5 row ml-2">
                                  <h6 class="col-md-11"><strong>Ulasan Penyelaras</strong></h6>
                                  <div class="userlist_content_header_right col-md-1">
                                    <!-- <button class="printing">
                                      <img
                                        src="{{ asset('assets/images/printing (1) 2.png') }}"
                                        alt="printing"
                                      />
                                    </button> -->
                                    ...
                                    <table class="table table-bordered projek_cmn_table">
                                      <thead>
                                        <tr>
                                          ...
                                          <th class="text-center">Perkara</th>
                                          <th class="text-center">Catatan</th>
                                          <th class="text-center"><button class="vmplus_minus" id="addUlasan" type="button"><i class="ri-add-box-line" style="color:#fff; font-size: 1.5rem"></i></button></th>
                                        </tr>
                                      </thead>
                                ...
                                <div class="row m-1 mt-3">
                                    ...
                                    <div class="upload_img col-md-7 col-xs-12" id="upload_memo">
                                        <div class="row col-12">
                                      ...
                                      <div class="image_preview border border-1 col-5" id="memo_preview">
                                          <div class="uploaded_img_preview_container d-flex justify-content-around mt-2" id="langing_header_1">
                                            <div class="uploaded_img">
                                  ...
                                  <div class="error" id="error_memo" style="color:red"></div>
                                ...
                                <div class="error ml-2" id="error_acknowledgement" style="color:red"></div>
                          </div>
                          
                          <div id="naik_laporan">
                            <div class="row mt-4 ml-2">
                              <div class="col-md-4 col-xs-12 d-flex">
                                <label for="">Muat Naik Laporan Makmal<sup>*</sup></label>
                              ...
                              <div  class="col-md-8 col-xs-12 row " >
                                <div class="upload_img col-md-6 col-xs-12" id="upload_lm">
                                  <div class="row col-12">
                            ...
                            <div class="error ml-1" id="error_laporanFileInput" style="color:red"></div>
                          </div>
                          ...
                          <div class="row m-1">
                            <div class="col-md-12 col-xs-12 p-0 py-1">
                              <div class="row align-items-center">
                                ...
                                <div class="col-md-12 col-xs-12 form-group d-flex">
                        ...
                        <div class="vmsimpan_hantar" id="penyeleras_buttons">
                            <button class="vmsimpan m-1" id="simpanUlusan" style="font-size:0.8rem !importnat;">Simpan</button>
                            <button class="vmkemaskini m-1" id="BalasKeBahagian" style="font-size:0.8rem !importnat;">Kemaskini Kepada Bahagian</button>
                            <button class="vmhantar m-1" id="SubmitToPenyeleras" style="font-size:0.8rem !importnat;">Hantar untuk Tandatangan Laporan</button>
                        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="ml-2 row mb-2">
            ...
            <div class="col-6 row">
              <label class="col-5 ml-3">Lokasi Makmal</label>
          ...
          <div class="ml-2 row mb-2">
            ...
            <div class="col-6 row">
              ...
              <input disabled type="text" class="form-control kos_data col-5 text-right" placeholder="0.00" value="" aria-label="Username" aria-describedby="basic-addon2" id="modal_kos_sebelum_makmal">
            </div>
          </div>
          <div class="ml-2 row mb-2">
            <div class="col-6 row">
              <label class="col-6" for="">Tahun Pelaksanaan Makmal</label>
              <input disabled class="form-control col-6" style="font-size: 0.8rem;" type="text" value="" id="modal_tahun">
            </div>
            <div class="col-6 row">
              <label  class="col-5 ml-3" for="">Kos Pelaksanaan <br> Selepas Makmal<br> </label>
              <span class="input-group-text kos_span col-1" id="basic-addon2">RM</span>
              <input  style="font-size: 0.8rem;" disabled type="text" class="form-control kos_data col-5 text-right" placeholder="0.00" value="" aria-label="Username" aria-describedby="basic-addon2" id="modal_kos_selepas_makmal">
            </div>
          </div>
          <div class="ml-2 row mb-2">
            <div class="col-6 row">
            ...
            <div class="modal-content add_role_sucess_modal_content" style="width:88% !important;">
              <div class="modal-body add_role_sucess_modal_body">
                ...
                <div class="add_role_sucess_modal_body_Content" id="user_pop-up">
                  <h5 style="width:102% !important; text-align: center;" id="hanter_text" class="d-none" >Laporan telah berjaya di hantar untuk di tandatangani<br></h5>
                  ...
                  <h5 style="width:102% !important; text-align: center;" id="tandakan_text"  class="d-none" >Laporan berjaya dihantar untuk ditandatangan<br></h5>
                  <h5 style="width:102% !important; text-align: center;" id="pengeculian_text"  class="d-none" >Pelaksanaan Makmal Kejuruteraan Nilai (VE) dikecualikan <br></h5>
            ...
            <div class="add_role_sucess_modal_container">
                ...
                >
                    ...
                    <div class="modal-body add_role_sucess_modal_body">
                        ...
                        <div class="add_role_sucess_modal_body_Content" id="user_pop-up">
                          <h5 style="width:102% !important; text-align: center;">Anda pasti untuk menghantar laporan untuk ditandatangan?</h5>
                          <div class="text-center">
...
@include('valueManagement.pelakasanan_makmal_VE.script')
@include('valueManagement.pelakasanan_makmal_VE.mmpm_script')
@include('valueManagement.pelakasanan_makmal_VE.butiran_script')

@include('valueManagement.pelakasanan_makmal_VE.ulasan_script')