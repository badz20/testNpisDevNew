        ...
        $(document).ready(function () {
            ...
            .then(function (response) { 
                ...
                $.each(response.data.data.vm, function (key, item) {
                        ...
                        if(item.project.status_perlaksanaan == '31' || item.project.status_perlaksanaan == '33') {
                            button = '<button type="button" onClick="removeMmpm('+item.id+')" class="sjm_table_btn"><i class="mdi mdi-window-close" style="font-size: 2em;" id="close_image"></i></button>'
                        }
                        let template = `<tr id="">
                                <td>`+ index +`</td>
