...
.Mainbody_conatiner .VAE-page .daya-accordion table tr .td-6, .Mainbody_conatiner .VAE-page .daya-accordion table tr .td-7 {
  width: 4%;
  font-size: 1.1rem;
  font-weight: 700;
  vertical-align: middle;
...
.vmskop_komponen thead tr {
  border-radius: 5px;
}
.vmskop_komponen thead tr th {
  background-color: #39b0d2;
  font-weight: 400;
  color: #fff;
  font-size: 12px;
...
.vmskop_komponen tbody {
  border: 1px solid #dee1e6;
  border-radius: 5px;
}
.vmskop_komponen tbody tr td {
  font-size: 12px;
  padding: 10px;
  border: 1px solid #dee1e6;
  text-align: left;
...
.vmskop_komponen tbody tr td:first-child {
  text-align: center;
}
.vmskop_komponen tbody tr td:last-child {
  text-align: right;
}
.vmkos {
  font-family: Poppins_regular;
...
.vmjumlah td:nth-child(2) {
  text-align: right;
}
.vmskop_kewangan table {
 border: none;  
}
.vmskop_kewangan td {
  font-family: Poppins_regular;
