...
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .rmk_flow_Chart .rmk_flow_Chart_container .rmk_flow_Chart_content_grey {
  width: 22%;
}
.Mainbody_conatiner .Mainbody_content .project_register_tab_container .project_register_tab_content_container .rmk_flow_Chart .rmk_flow_Chart_container .rmk_flow_Chart_content_grey h5 {
  font-size: 0.75rem;
...
.brief_project_container .brief_project_content label sup {
  font-size: 0.9rem;
  color: red;
}
.vmplus_minus {
...
p#sjm_file_size, p#sjm_file_type {
    padding-left: 75%;
    color: red;
}
p#mini_file_size, p#mini_file_type {
    color: red;
    padding-left: 25%;
}
p#laporan_file_size, p#laporan_file_type {
    padding-left: 25%;
    color: red;
}

p#memo_file_type, p#memo_file_size {
    padding-left: 25%;
    color: red;
}
div#mini_preview, div#lm_preview {
...
.projek_cmn_table_skop {
  width: 50% !important;
  height: auto;
  float: left;
}
.projek_cmn_table_skop thead tr {
  border-radius: 5px;
  overflow: hidden;
}
.projek_cmn_table_skop thead tr th {
  background-color: #39b0d2;
  font-weight: 400;
  color: #fff;
  font-size: 13px;
...
.projek_cmn_table_skop tbody {
  border: 1px solid #dee1e6;
  border-radius: 5px;
}
.projek_cmn_table_skop tbody tr td {
  font-size: 12px;
  padding: 10px;
  text-align: left;
}

textarea.form-control.text-center {
...
/* button#SubmitToPenyeleras {
    opacity: 0.5;
} */

button#tutup-confirm{
    margin: 2% 0 3% 0;
        background-color: #5b64c3;
        color: #fff;
        border: none;
...
.vmadd_role_sucess_modal_container #exampleModal input {
  font-size: 0.8rem!important;
}
.vmpop_btn {
  position: relative;
...
.muat_naik_file_class{
  cursor:pointer;
}

button.sjm_table_btn {
