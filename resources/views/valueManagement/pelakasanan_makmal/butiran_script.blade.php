...
<script>
        ...
        $(document).ready(function () {
                                ...
                                $.each(item.fasilitators, function(key, items) { 
                                        $('#butiran_tbody').append(`<tr class="mainrow">
                                                                <input style="font-size: 0.8rem;" class="form-control text-center" type="hidden" value="" name="id">
                                                                                ...
                                                                                <td>
                                                                                       <input style="font-size: 0.8rem;" type="text" id="fas_select" disabled class="form-control" value="`+items.fasilitator.nama_fasilitator+`">
                                                                                </td>
                ...
                .then(function (response) { 
                        ...
                        console.log(fasilitators)
                        
                        all_main_fas_select.forEach((tb, i) => { 
                                tb.addEventListener("change", function(evt){ console.log(all_main_fas_select[i].value)
                                        fasil = fasilitators[all_main_fas_select[i].value]; console.log(fasil.grade)
                        ...
                        // let all_main_fasility_type = document.querySelectorAll("[id='fasility_type']");  console.log(all_main_fasility_type);

                        // all_main_fas_type.forEach((tb, i) => { 
                        //         tb.addEventListener("change", function(evt){
                        //                 fasil = fasilitators[all_main_fas_type[i].value]; console.log(fasil);
...
<script>
        ...
        $('#submit_butiran').click(function(){
                ...
                if(kos_pelakas_selepas_makmal == '') {
                        document.getElementById("error_kos_pelakas_selepas_makmal").innerHTML = 'Sila isi Kos Pelaksanaan Makmal (Selepas)'
                }
