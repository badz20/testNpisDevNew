                ...
                .then(function (response) { 
                        ...
                        $.each(butiranData, function(key, item) {
                                ...
                                $.each(item.fasilitators, function(key, items) { 
                                        $('#butiran_tbody').append(`<tr class="mainrow">
                                                                <input style="font-size: 0.8rem;" class="form-control text-center" type="hidden" value="" name="id">
                                                                                ...
                                                                                <td>
                                                                                        <input style="font-size: 0.8rem;" type="text" disabled class="form-control" value="`+items.fasilitator_type+`">
                                                                                </td>
                                ...
                                if({{$user}}==4)
                                {
                                   ...
                                   document.getElementById("kos_sebelum_makmal").value = numbber_format(item.kos_sebelum_makmal);
                                   document.getElementById("kos_pelakas_selepas_makmal").value = number_format(item.kos_pelakas_selepas_makmal);
                                }
                        })
