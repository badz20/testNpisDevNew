          ...
          $("#save_password").click(function(){
             ...
             /* When the user clicks on the button, 
              ...
              $("#menu").click(function(){
                ...
                $(".project_register_search_container").css("width","83%")
                $(".Mainbody_content_nav_header project_register").css("width","90%")
                $(".project_register_search_container").css("float","right")
                $(".Mainbody_conatiner").css("width","100%")
                $(".cardVE").css("width","100%")
                $(".cardVE").css("float","right")
                $(".cardVE").css("left","150px")
                $(".fixed_nav").css("left","0 %")
              $(".dashboard").css("left","100% !important")

                $(".Mainbody_conatiner .Mainbody_content .project_register_content_container").css("width","83% !important")
                $(".Mainbody_conatiner .Mainbody_content .project_register_content_container").css("float","right")
                $(".Mainbody_conatiner .Mainbody_content .Mainbody_content_nav_header.project_register").css("width","87% !important")
              ...
              document.querySelector("#round").addEventListener("click", () => {
                ...
                $(".Mainbody_content_nav_header project_register").css("width","100%")
