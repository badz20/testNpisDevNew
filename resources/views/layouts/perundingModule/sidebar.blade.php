...
<body id="index" class="white project_register">
    ...
    <div class="NPIS_Container">
      ...
      <div class="side_bar_Container dashboard Project_application" id="navbarCollapse">
            ...
            @if($user_is==1)
              <li class="accordian_content d-flex">
                <div class="sidebar_icon">
                  <img src="{{ asset('Vm_module/assets/images/Vector-9.png') }}" alt="Vector9" />
                </div>
              ...
              <li class="accordian_content d-none" id="sidebar_6">
                ...
                <div class="accordian_single_list">
                  ...
                  <ul class="">
                    <li><a href="#">Dashboard</a></li>
                    <li><a href="#">SENARAI PROJEK</a></li>
                      <ul><a href="/senarai_makmal_and_mini">Senarai Makmal VM</a></ul>
                      <ul><a href="/senarai_selasai_makmal">Senarai Selesai Makmal</a></ul>
                    <li><a href="#">Maklumat Perancangan Makmal Tahunan</a></li>
                    @if($userType==4)
