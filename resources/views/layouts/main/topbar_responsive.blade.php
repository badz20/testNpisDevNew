  ...
  <div class="Mainbody_conatiner user_profile">
      ...
      <nav class="fixed_nav" style="z-index: 1!important; position: absolute;">
        <div class="col-12 row">
          <div class="nav_bar col-12" >
            <div class="Nav_left_Input_content d-flex align-items-center">
              <div class="logo_menu">
                ...
                <div class="Nav_right_img_content d-flex">
                  ...
                  <div class="icons_contains">
                    ...
                    <div class="dropdown">
                      ...
                      <div id="notification-badge" class="notification-icon d-none"></div>
                    </div>
                ...
                <div class="change_password_modal_form">
                  <form name="change_password_form">
                    <div class="form-group input_content row">
                      ...
                      <input type="password" class="form-control col-6" id="old_password" name="old_password" placeholder="">
                      <span class="error" id="error_old_password"></span>
                    </div>
                    <div class="form-group input_content row">
                      <label for="new_password" class="required col-6">Kata Laluan Baharu</label>
                      <input type="password" class="form-control col-6" id="new_password" name="new_password" placeholder="">
                    ...
                    <div class="form-group input_content row">
                      ...
                      <input type="password" class="form-control col-6" id="confirm_password" name="confirm_password" placeholder="">
    ...
    <script>
      $(document).ready(function(){
        ...
        var user_is     =   {{Auth::user()->is_superadmin}};
        axios({
          method: 'get',
          url: "{{ env('API_URL') }}"+"api/user/get-notifications?user_id="+user_id+"&user_is="+user_is,
          responseType: 'json'
        }).then(function(response) {

          if(response.data.data.length > 0 || response.data.count_penyemak > 0 || 
          response.data.count_pengesah > 0 || response.data.count_peraku > 0) {
        ...
        if(localStorage.getItem("jawatan_name"))
        {
          ...
          console.log(localStorage.getItem("profile_path"))
        ...
        function loadJawatan()
        {
          ...
          $.ajax({
              ...
              success: function(response) {
                // console.log(response.profilePic.original_url)
