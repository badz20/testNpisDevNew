              ...
              <div class="nav_bar col-12">
                <div class="Nav_left_Input_content d-flex align-items-center">
                  ...
                  <!-- <div class="d-flex searchInput" style="margin-left: 5%;">
                    <input type="text" class="form-control" id="searchBar" name="searchQuery"/>
...
<!--------------------------------------------------- change_password_modal_container ends-------------------------- -->
        ...
        <script>
          ...
          $(document).ready(function(){
            ...
            console.log(logo1=='')
            if(logo1==''){
              $("#logo-1").attr('src','assets/images/Jata-Malaysia-Vector-01 6.png').css({"height":'60px'})
            }
            else{
            ...
            // console.log(logo2=='')
            if(logo2==''){
              $("#logo-2").attr('src',"assets/images/logo-jab-pengairan-saliran-msia__400x293 6.png").css({"height":'50px'})
            }
            else{
                ...
                $.ajaxSetup({
                    ...
                    axios({
                      ...
                      .then(function(response) {
                        ...
                        //                       <hr>`);
                        // }
console.log(daftar_count);
console.log(penye_count);
console.log(pengesah_count);
console.log(peraku_count);
