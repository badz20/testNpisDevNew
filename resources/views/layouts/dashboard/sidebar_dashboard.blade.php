...
<body id="index">
  ...
  <div id="loading-bar-spinner" class="spinner" style="display:none;"><div class="spinner-icon"></div></div>
    <div class="NPIS_Container">
      ...
      <div class="side_bar_Container dashboard" style="top: 0px;left:-50px;overflow-y: scroll;">
            ...
            <a href="/home" class="text-dark d-flex">
              ...
              <div class="NPIS_logo_right_content text-white">
                ...
                <div id="round" class="ml-auto round_parent">
                  <div class="round"><input id="fixedSwitch" type="hidden"></div>
                </div>
              </div>
          </div>
          ...
          <div class="sidebar_list_container">
            ...
            @endif
                ...
                <div class="accordian_single_list">
                  <div class="Accordian-header" id="headingTwo">
                    <a
                      ...
                      data-toggle="collapse"
                      href="#permohonan" aria-expanded="true"
                    >
                      <div class="d-flex sidebar_icon_Container">
                        <div class="sidebar_icon_right_content">
                          <div class="d-flex sb_contents">
                  ...
                  >
                    {{-- <ul class="">
                      ...
                      <li><a href="Daftar-Permohonan-Projek">Daftar Permohonan Projek</a></li>
              ...
              <li class="accordian_content d-none" id="sidebar_6">
                ...
                <div class="accordian_single_list">
                  <div class="Accordian-header" id="headingTwo">
                    <a class="text-left Accordian_link" data-toggle="collapse" href="#value_management" aria-expanded="true">
                      <div class="d-flex sidebar_icon_Container">
                        <div class="sidebar_icon_right_content">
                          <div class="d-flex sb_contents">
                            <p>Value Management</p>
                            <div>
                              <img src='{{ asset("assets/images/down arrow.png") }}' class="d_arrow active" alt="d_arrow">
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div id="value_management" class="accordian_collapse_list collapse" aria-labelledby="headingTwo" data-parent="#accordionParent" style="">
                  <ul class="">
