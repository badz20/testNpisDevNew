              ...
              <div class="Nav_right_content d-flex align-items-center">
                ...
                <div class="dropdown ml-5">
                  ...
                  >
                    <div class="profile_container d-flex">
                      <div class="profile_img">
                        <img id="profile_image" src='{{ asset("assets/images/profiler.png") }}' alt="Admin" />
                      </div>
                  ...
                  {{-- 2023 March 21 by Nabilah --}}
                    <a class="dropdown-item" href="{{ url('/user-profile/appuser', Auth::user()->id)}}">
                      <img
                      src="{{ asset('assets/images/coolicon_grey.png') }}"
                        class="globe"
                        alt="globe"
                      />
                      Profil Pengguna
                    ...
                    <a class="dropdown-item" href="#"  data-target="#Change_password_modal" data-toggle="modal" data-backdrop="static" data-keyboard="false">
                      <img
                      src="{{ asset('assets/images/image_256_grey.png') }}"
                        class="globe"
                        alt="globe"
                    ...
                    <a class="dropdown-item" href="{{ url('user/logout') }}">
                      <img
                      src="{{ asset('assets/images/image_255_grey.png') }}"
                        class="globe"
                        alt="globe"
                      />
                     Logout
