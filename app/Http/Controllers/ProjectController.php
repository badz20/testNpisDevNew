...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('project.list.project-application-list',['user'=>$user,'role'=>$userRole,'negeri'=>$negeri,'daerah'=>$daerah,
    ...
    public function PermohonanProjekList(){ 
        ...
        return view('project.Permohonan-Projek-list.projectlist',['user'=>$user,'role'=>$userRole,'negeri'=>$negeri,'daerah'=>$daerah,
    ...
    public function SemakProjekList(){
        ...
        return view('project.semak.project-list',['user'=>$user,'role'=>$userRole,'negeri'=>$negeri,'daerah'=>$daerah,
        'bahagian'=>$bahagian,'penyemak'=>$penyemak,'penyemak_1'=>$penyemak_1,'penyemak_2'=>$penyemak_2,'pengesah'=>$pengesah,'peraku'=>$peraku]);
    }
    ...
    public function PengesahanProjekList(){
        ...
        return view('project.pengesah-list.project-list',['user'=>$user,'role'=>$userRole,'negeri'=>$negeri,'daerah'=>$daerah,
        'bahagian'=>$bahagian,'penyemak'=>$penyemak,'penyemak_1'=>$penyemak_1,'penyemak_2'=>$penyemak_2,'pengesah'=>$pengesah,'peraku'=>$peraku]);
    }
    ...
    public function PerakuProjekList(){
        ...
        return view('project.peraku-list.project-list',['user'=>$user,'role'=>$userRole,'negeri'=>$negeri,'daerah'=>$daerah,
        'bahagian'=>$bahagian,'penyemak'=>$penyemak,'penyemak_1'=>$penyemak_1,'penyemak_2'=>$penyemak_2,'pengesah'=>$pengesah,'peraku'=>$peraku]);
    }
    ...
    public function SalinProjekList(){
        ...
        return view('project.salin.project-list',['user'=>$user,'role'=>$userRole,'negeri'=>$negeri,'daerah'=>$daerah,
        'bahagian'=>$bahagian,'penyemak'=>$penyemak,'penyemak_1'=>$penyemak_1,'penyemak_2'=>$penyemak_2,'pengesah'=>$pengesah,'peraku'=>$peraku]);
    }
    ...
    public function daftar()
    {
        ...
        return view('project.daftar.Daftar-Permohonan-Projek',['user'=>$user,'role'=>$userRole,'negeri'=>$negeri,'daerah'=>$daerah,
        'bahagian'=>$bahagian,'penyemak'=>$penyemak,'penyemak_1'=>$penyemak_1,'penyemak_2'=>$penyemak_2,'pengesah'=>$pengesah,'viewOnly'=>$viewOnly,'peraku'=>$peraku]);
    }
    ...
    public function setEnableorDisable($status,$user_id) //enable or disable buttons
    {
        ...
        if($user==2)
        {
            ...
            else if(($status==2 && $penyemak==1) || ($status==4 && $penyemak_1==1))
            { //negeri or daerah
                return 1;
            }
